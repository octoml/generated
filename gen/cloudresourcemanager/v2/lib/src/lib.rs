...
pub mod schemas {
    ...
    pub struct Folder {
        ...
        #[doc = "Required. The Folder’s parent's resource name.\nUpdates to the folder's parent must be performed via\nMoveFolder."]
        #[serde(
            rename = "parent",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::std::convert::AsRef<str> for FolderLifecycleState {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for FolderLifecycleState {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<FolderLifecycleState, ()> {
            Ok(match s {
    ...
    impl ::google_field_selector::FieldSelector for FolderLifecycleState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for FolderLifecycleState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ListFoldersResponse {
        #[doc = "A possibly paginated list of Folders that are direct descendants of\nthe specified parent resource."]
        #[serde(
            rename = "folders",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "A pagination token returned from a previous call to `ListFolders`\nthat indicates from where listing should continue."]
        #[serde(
    ...
    pub struct MoveFolderRequest {
        #[doc = "Required. The resource name of the Folder or Organization to reparent\nthe folder under.\nMust be of the form `folders/{folder_id}` or `organizations/{org_id}`."]
        #[serde(
            rename = "destinationParent",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for MoveFolderRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for MoveFolderRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct SearchFoldersRequest {
        ...
        #[doc = "Optional. A pagination token returned from a previous call to `SearchFolders`\nthat indicates from where search should continue."]
        #[serde(
            rename = "pageToken",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for SearchFoldersRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SearchFoldersRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct SearchFoldersResponse {
        #[doc = "A possibly paginated folder search results.\nthe specified parent resource."]
        #[serde(
            rename = "folders",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub folders: ::std::option::Option<Vec<crate::schemas::Folder>>,
        #[doc = "A pagination token returned from a previous call to `SearchFolders`\nthat indicates from where searching should continue."]
        #[serde(
            rename = "nextPageToken",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for SearchFoldersResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SearchFoldersResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for UndeleteFolderRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for UndeleteFolderRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
pub mod resources {
    pub mod folders {
        ...
        impl<'a> FoldersActions<'a> {
            ...
            pub fn create(&self, request: crate::schemas::Folder) -> CreateRequestBuilder {
            ...
            pub fn r#move(
                &self,
                request: crate::schemas::MoveFolderRequest,
            ...
            pub fn search(
                &self,
                request: crate::schemas::SearchFoldersRequest,
            ...
            pub fn undelete(
                &self,
                request: crate::schemas::UndeleteFolderRequest,
                name: impl Into<String>,
        ...
        impl<'a> CreateRequestBuilder<'a> {
            #[doc = "Required. The resource name of the new Folder's parent.\nMust be of the form `folders/{folder_id}` or `organizations/{org_id}`."]
        ...
        impl<'a> DeleteRequestBuilder<'a> {
            ...
            #[doc = r" response resource and should be limited to use during"]
            #[doc = r" development or debugging."]
            pub fn execute_with_all_fields(self) -> Result<crate::schemas::Folder, crate::Error> {
                self.execute_with_fields(Some("*"))
            }
            #[doc = r" Execute the given operation. This will use the `fields`"]
            #[doc = r" selector provided and will deserialize the response into"]
        ...
        #[doc = "Created via [FoldersActions::get_iam_policy()](struct.FoldersActions.html#method.get_iam_policy)"]
        #[derive(Debug, Clone)]
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            #[doc = "Optional. A pagination token returned from a previous call to `ListFolders`\nthat indicates where this listing should continue from."]
            pub fn page_token(mut self, value: impl Into<String>) -> Self {
                self.page_token = Some(value.into());
                self
            }
            #[doc = "Required. The resource name of the Organization or Folder whose Folders are\nbeing listed.\nMust be of the form `folders/{folder_id}` or `organizations/{org_id}`.\nAccess to this method is controlled by checking the\n`resourcemanager.folders.list` permission on the `parent`."]
            pub fn parent(mut self, value: impl Into<String>) -> Self {
                self.parent = Some(value.into());
                self
            }
            #[doc = "Optional. Controls whether Folders in the\nDELETE_REQUESTED\nstate should be returned. Defaults to false."]
            ...
            pub fn iter_folders<T>(self) -> crate::iter::PageItemIter<Self, T>
            where
                T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
            {
                let fields = ::google_field_selector::to_string::<T>();
                ...
                self.iter_folders_with_fields(fields)
            }
            #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
            #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
            #[doc = r" fields in `#items_type` will be the default fields populated by"]
            #[doc = r" the server."]
            pub fn iter_folders_with_default_fields(
                self,
            ) -> crate::iter::PageItemIter<Self, crate::schemas::Folder> {
                self.iter_folders_with_fields(None::<String>)
            }
            #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
            #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
            ...
            #[doc = r" resources."]
            pub fn iter_folders_with_all_fields(
                self,
            ) -> crate::iter::PageItemIter<Self, crate::schemas::Folder> {
                self.iter_folders_with_fields(Some("*"))
            }
            pub fn iter_folders_with_fields<T, F>(
                mut self,
                fields: Option<F>,
            ...
            {
                self.fields = Some({
                    let mut selector = concat!("nextPageToken,", "folders").to_owned();
        ...
        #[doc = "Created via [FoldersActions::r#move()](struct.FoldersActions.html#method.r#move)"]
        #[derive(Debug, Clone)]
        ...
        #[doc = "Created via [FoldersActions::patch()](struct.FoldersActions.html#method.patch)"]
        #[derive(Debug, Clone)]
        ...
        impl<'a> PatchRequestBuilder<'a> {
            #[doc = "Required. Fields to be updated.\nOnly the `display_name` can be updated."]
        ...
        #[doc = "Created via [FoldersActions::search()](struct.FoldersActions.html#method.search)"]
        #[derive(Debug, Clone)]
        ...
        impl<'a> SearchRequestBuilder<'a> {
            ...
            pub fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::SearchFoldersResponse, crate::Error> {
                self.execute_with_fields(None::<&str>)
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            fn _path(&self) -> String {
                let mut output = "https://cloudresourcemanager.googleapis.com/".to_owned();
                output.push_str("v2/folders:search");
                output
            }
            fn _request(
                &self,
        ...
        #[doc = "Created via [FoldersActions::set_iam_policy()](struct.FoldersActions.html#method.set_iam_policy)"]
        #[derive(Debug, Clone)]
        ...
        #[doc = "Created via [FoldersActions::test_iam_permissions()](struct.FoldersActions.html#method.test_iam_permissions)"]
        #[derive(Debug, Clone)]
        ...
        #[doc = "Created via [FoldersActions::undelete()](struct.FoldersActions.html#method.undelete)"]
        #[derive(Debug, Clone)]
