#![doc = "# Resources and Methods\n    * [users](resources/users/struct.UsersActions.html)\n      * [environments](resources/users/environments/struct.EnvironmentsActions.html)\n        * [*authorize*](resources/users/environments/struct.AuthorizeRequestBuilder.html), [*get*](resources/users/environments/struct.GetRequestBuilder.html), [*patch*](resources/users/environments/struct.PatchRequestBuilder.html), [*start*](resources/users/environments/struct.StartRequestBuilder.html)\n        * [public_keys](resources/users/environments/public_keys/struct.PublicKeysActions.html)\n          * [*create*](resources/users/environments/public_keys/struct.CreateRequestBuilder.html), [*delete*](resources/users/environments/public_keys/struct.DeleteRequestBuilder.html)\n"]
pub mod scopes {
...
pub mod schemas {
    ...
    impl ::google_field_selector::FieldSelector for AuthorizeEnvironmentRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AuthorizeEnvironmentRequest {
    ...
    impl ::google_field_selector::FieldSelector for CreatePublicKeyRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CreatePublicKeyRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub enum EnvironmentState {
        ...
        Running,
        #[doc = "The environment is being started but is not yet ready to accept\nconnections."]
        Starting,
    ...
    impl ::google_field_selector::FieldSelector for EnvironmentState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for EnvironmentState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl PublicKeyFormat {
        pub fn as_str(self) -> &'static str {
            match self {
                PublicKeyFormat::EcdsaSha2Nistp256 => "ECDSA_SHA2_NISTP256",
                PublicKeyFormat::EcdsaSha2Nistp384 => "ECDSA_SHA2_NISTP384",
                PublicKeyFormat::EcdsaSha2Nistp521 => "ECDSA_SHA2_NISTP521",
                PublicKeyFormat::FormatUnspecified => "FORMAT_UNSPECIFIED",
    ...
    impl ::google_field_selector::FieldSelector for PublicKeyFormat {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for PublicKeyFormat {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for StartEnvironmentMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub enum StartEnvironmentMetadataState {
        ...
        StateUnspecified,
        #[doc = "Startup is waiting for the user's disk to be unarchived. This can happen\nwhen the user returns to Cloud Shell after not having used it for a\nwhile, and suggests that startup will take longer than normal."]
        UnarchivingDisk,
    }
    ...
    impl ::serde::Serialize for StartEnvironmentMetadataState {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for StartEnvironmentMetadataState {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for StartEnvironmentMetadataState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for StartEnvironmentMetadataState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for StartEnvironmentRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for StartEnvironmentRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for StartEnvironmentResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
pub mod resources {
    pub mod users {
        ...
        impl<'a> UsersActions<'a> {
            ...
            pub fn environments(
                &self,
            ) -> crate::resources::users::environments::EnvironmentsActions {
                crate::resources::users::environments::EnvironmentsActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
        ...
        pub mod environments {
            ...
            impl<'a> EnvironmentsActions<'a> {
                ...
                pub fn authorize(
                    &self,
                    request: crate::schemas::AuthorizeEnvironmentRequest,
                ...
                pub fn start(
                    &self,
                    request: crate::schemas::StartEnvironmentRequest,
                    name: impl Into<String>,
                ) -> StartRequestBuilder {
                    StartRequestBuilder {
                        reqwest: &self.reqwest,
                ...
                #[doc = "Actions that can be performed on the public_keys resource"]
                pub fn public_keys(
                    &self,
                ) -> crate::resources::users::environments::public_keys::PublicKeysActions
                {
                    crate::resources::users::environments::public_keys::PublicKeysActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
            ...
            #[doc = "Created via [EnvironmentsActions::authorize()](struct.EnvironmentsActions.html#method.authorize)"]
            #[derive(Debug, Clone)]
            pub struct AuthorizeRequestBuilder<'a> {
                pub(crate) reqwest: &'a ::reqwest::blocking::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                request: crate::schemas::AuthorizeEnvironmentRequest,
                name: String,
            ...
            impl<'a> AuthorizeRequestBuilder<'a> {
                ...
                fn _path(&self) -> String {
                    let mut output = "https://cloudshell.googleapis.com/".to_owned();
            ...
            #[doc = "Created via [EnvironmentsActions::start()](struct.EnvironmentsActions.html#method.start)"]
            #[derive(Debug, Clone)]
            ...
            pub mod public_keys {
                pub mod params {}
                pub struct PublicKeysActions<'a> {
                    pub(crate) reqwest: &'a reqwest::blocking::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                }
                impl<'a> PublicKeysActions<'a> {
                    fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                        self.auth
                    }
                    ...
                    pub fn create(
                        &self,
                        request: crate::schemas::CreatePublicKeyRequest,
                ...
                #[doc = "Created via [PublicKeysActions::create()](struct.PublicKeysActions.html#method.create)"]
                #[derive(Debug, Clone)]
                ...
                #[doc = "Created via [PublicKeysActions::delete()](struct.PublicKeysActions.html#method.delete)"]
                #[derive(Debug, Clone)]
