...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        ...
        {
            let mcmd = SubCommand::with_name("get_iam_policy").about("Gets the IAM access control policy for a function.\nReturns an empty policy if the function exists and does not have a policy\nset.");
            functions2 = functions2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list")
        ...
        {
            let mcmd = SubCommand::with_name("set_iam_policy").about("Sets the IAM access control policy on the specified function.\nReplaces any existing policy.");
            functions2 = functions2.subcommand(mcmd);
        }
        {
