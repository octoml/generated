...
pub mod schemas {
    ...
    pub struct StandardResourceMetadata {
        ...
        pub location: ::std::option::Option<String>,
        #[doc = "The full resource name. For example:\n`//compute.googleapis.com/projects/my_project_123/zones/zone1/instances/instance1`.\nSee [Resource\nNames](https://cloud.google.com/apis/design/resource_names#full_resource_name)\nfor more information."]
        #[serde(
            rename = "name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
...
pub mod resources {
    pub mod iam_policies {
        ...
        impl<'a> crate::iter::IterableMethod for SearchAllRequestBuilder<'a> {
    ...
    pub mod resources {
        ...
        impl<'a> SearchAllRequestBuilder<'a> {
            ...
            pub fn iter_results_with_default_fields(
                self,
            ) -> crate::iter::PageItemIter<Self, crate::schemas::StandardResourceMetadata>
            {
                self.iter_results_with_fields(None::<String>)
            }
            #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
