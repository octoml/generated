...
pub mod schemas {
    ...
    pub struct BuildTrigger {
        #[doc = "Contents of the build template."]
        #[serde(
            rename = "build",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub build: ::std::option::Option<crate::schemas::Build>,
        #[doc = "Output only. Time when the trigger was created."]
        #[serde(
            rename = "createTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub create_time: ::std::option::Option<String>,
        #[doc = "Human-readable description of this trigger."]
        #[serde(
            rename = "description",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "If true, the trigger will never result in a build."]
        #[serde(
            rename = "disabled",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Path, from the source root, to a file whose contents is used for the\ntemplate."]
        #[serde(
            rename = "filename",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "If any of the files altered in the commit pass the ignored_files\nfilter and included_files is empty, then as far as this filter is\nconcerned, we should trigger the build.\n\nIf any of the files altered in the commit pass the ignored_files\nfilter and included_files is not empty, then we make sure that at\nleast one of those files matches a included_files glob. If not,\nthen we do not trigger a build."]
        #[serde(
        ...
        pub substitutions: ::std::option::Option<::std::collections::BTreeMap<String, String>>,
        #[doc = "Tags for annotation of a `BuildTrigger`"]
        #[serde(
            rename = "tags",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub trigger_template: ::std::option::Option<crate::schemas::RepoSource>,
    }
    impl ::google_field_selector::FieldSelector for BuildTrigger {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for BuildTrigger {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for CancelBuildRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CancelBuildRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct GitHubEventsConfig {
        #[doc = "The installationID that emits the GitHub event."]
        #[serde(
        ...
        #[doc = "Name of the repository. For example: The name for\nhttps://github.com/googlecloudplatform/cloud-builders is \"cloud-builders\"."]
        #[serde(
            rename = "name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub name: ::std::option::Option<String>,
        #[doc = "Owner of the repository. For example: The owner for\nhttps://github.com/googlecloudplatform/cloud-builders is\n\"googlecloudplatform\"."]
        #[serde(
            rename = "owner",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub owner: ::std::option::Option<String>,
    ...
    impl ::google_field_selector::FieldSelector for GitHubEventsConfig {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    ...
    pub struct ListBuildTriggersResponse {
        #[doc = "Token to receive the next page of results."]
        #[serde(
        ...
        #[doc = "`BuildTriggers` for the project, sorted by `create_time` descending."]
        #[serde(
            rename = "triggers",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub triggers: ::std::option::Option<Vec<crate::schemas::BuildTrigger>>,
    }
    impl ::google_field_selector::FieldSelector for ListBuildTriggersResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListBuildTriggersResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ListBuildsResponse {
        #[doc = "Builds will be sorted by `create_time`, descending."]
        #[serde(
            rename = "builds",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub builds: ::std::option::Option<Vec<crate::schemas::Build>>,
        #[doc = "Token to receive the next page of results."]
        #[serde(
            rename = "nextPageToken",
            default,
    ...
    impl ::google_field_selector::FieldSelector for ListBuildsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListBuildsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for PullRequestFilter {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum PullRequestFilterCommentControl {
        #[doc = "Do not require comments on Pull Requests before builds are triggered."]
        CommentsDisabled,
        #[doc = "Enforce that repository owners or collaborators must comment on Pull\nRequests before builds are triggered."]
        CommentsEnabled,
    }
    impl PullRequestFilterCommentControl {
        pub fn as_str(self) -> &'static str {
            match self {
                PullRequestFilterCommentControl::CommentsDisabled => "COMMENTS_DISABLED",
                PullRequestFilterCommentControl::CommentsEnabled => "COMMENTS_ENABLED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for PullRequestFilterCommentControl {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for PullRequestFilterCommentControl {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<PullRequestFilterCommentControl, ()> {
            Ok(match s {
                "COMMENTS_DISABLED" => PullRequestFilterCommentControl::CommentsDisabled,
                "COMMENTS_ENABLED" => PullRequestFilterCommentControl::CommentsEnabled,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for PullRequestFilterCommentControl {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for PullRequestFilterCommentControl {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for PullRequestFilterCommentControl {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for PullRequestFilterCommentControl {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for PullRequestFilterCommentControl {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct PushFilter {
        #[doc = "Regexes matching branches to build.\n\nThe syntax of the regular expressions accepted is the syntax accepted by\nRE2 and described at https://github.com/google/re2/wiki/Syntax"]
        #[serde(
            rename = "branch",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for PushFilter {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for PushFilter {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for RetryBuildRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for RetryBuildRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
pub mod resources {
    ...
    pub mod projects {
        ...
        impl<'a> ProjectsActions<'a> {
            ...
            #[doc = "Actions that can be performed on the builds resource"]
            pub fn builds(&self) -> crate::resources::projects::builds::BuildsActions {
                crate::resources::projects::builds::BuildsActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
            }
            ...
            pub fn triggers(&self) -> crate::resources::projects::triggers::TriggersActions {
                crate::resources::projects::triggers::TriggersActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
            }
        ...
        pub mod builds {
            ...
            impl<'a> CancelRequestBuilder<'a> {
                ...
                pub fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::Build, crate::Error> {
                    self.execute_with_fields(None::<&str>)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            impl<'a> ListRequestBuilder<'a> {
                #[doc = "The raw filter text to constrain the results."]
                pub fn filter(mut self, value: impl Into<String>) -> Self {
                    self.filter = Some(value.into());
                    self
                }
                #[doc = "Number of results to return in the list."]
                pub fn page_size(mut self, value: i32) -> Self {
                    self.page_size = Some(value);
                    self
                }
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_builds<T>(self) -> crate::iter::PageItemIter<Self, T>
                where
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
                {
                    let fields = ::google_field_selector::to_string::<T>();
                    ...
                    self.iter_builds_with_fields(fields)
                }
                #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                #[doc = r" fields in `#items_type` will be the default fields populated by"]
                #[doc = r" the server."]
                pub fn iter_builds_with_default_fields(
                    self,
                ) -> crate::iter::PageItemIter<Self, crate::schemas::Build> {
                    self.iter_builds_with_fields(None::<String>)
                }
                #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                #[doc = r" fields in `#items_type` will be all fields available. This should"]
                ...
                #[doc = r" all fields can be expensive both in bandwidth and server"]
                #[doc = r" resources."]
                pub fn iter_builds_with_all_fields(
                    self,
                ) -> crate::iter::PageItemIter<Self, crate::schemas::Build> {
                    self.iter_builds_with_fields(Some("*"))
                }
                pub fn iter_builds_with_fields<T, F>(
                    mut self,
                    fields: Option<F>,
                ) -> crate::iter::PageItemIter<Self, T>
                where
                ...
                {
                    self.fields = Some({
                        let mut selector = concat!("nextPageToken,", "builds").to_owned();
                        let items_fields = fields.as_ref().map(|x| x.as_ref()).unwrap_or("");
                        if !items_fields.is_empty() {
                            selector.push_str("(");
                            selector.push_str(items_fields);
                    ...
                    crate::iter::PageItemIter::new(self, "builds")
                }
                pub fn iter<T>(self) -> crate::iter::PageIter<Self, T>
                where
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
                ...
                pub fn iter_with_default_fields(
                    self,
                ) -> crate::iter::PageIter<Self, crate::schemas::ListBuildsResponse>
                {
                    self.iter_with_fields(None::<&str>)
                }
                pub fn iter_with_all_fields(
                ...
                pub fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::ListBuildsResponse, crate::Error> {
                    self.execute_with_fields(None::<&str>)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
        ...
        pub mod triggers {
            ...
            impl<'a> CreateRequestBuilder<'a> {
                ...
                pub fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::BuildTrigger, crate::Error> {
                    self.execute_with_fields(None::<&str>)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_triggers<T>(self) -> crate::iter::PageItemIter<Self, T>
                where
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
                {
                    let fields = ::google_field_selector::to_string::<T>();
                    ...
                    self.iter_triggers_with_fields(fields)
                }
                #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                #[doc = r" fields in `#items_type` will be the default fields populated by"]
                #[doc = r" the server."]
                pub fn iter_triggers_with_default_fields(
                    self,
                ) -> crate::iter::PageItemIter<Self, crate::schemas::BuildTrigger> {
                    self.iter_triggers_with_fields(None::<String>)
                }
                #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                #[doc = r" fields in `#items_type` will be all fields available. This should"]
                ...
                #[doc = r" all fields can be expensive both in bandwidth and server"]
                #[doc = r" resources."]
                pub fn iter_triggers_with_all_fields(
                    self,
                ) -> crate::iter::PageItemIter<Self, crate::schemas::BuildTrigger> {
                    self.iter_triggers_with_fields(Some("*"))
                }
                pub fn iter_triggers_with_fields<T, F>(
                    mut self,
                    fields: Option<F>,
                ) -> crate::iter::PageItemIter<Self, T>
                where
                    ...
                    F: AsRef<str>,
                {
                    ...
                    crate::iter::PageItemIter::new(self, "triggers")
                }
                pub fn iter<T>(self) -> crate::iter::PageIter<Self, T>
                where
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
                ...
                pub fn iter_with_default_fields(
                    self,
                ) -> crate::iter::PageIter<Self, crate::schemas::ListBuildTriggersResponse>
                {
                    self.iter_with_fields(None::<&str>)
                }
                pub fn iter_with_all_fields(
                ...
                pub fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::ListBuildTriggersResponse, crate::Error>
                {
                    self.execute_with_fields(None::<&str>)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
