...
pub mod schemas {
    ...
    pub enum CustomRankingInfoImportanceLevel {
        ...
        Extreme,
        #[doc = "The given ranking expression is of High importance in terms of job's\nfinal ranking position compared to existing relevance\nscore (determined by API algorithm)."]
        High,
        #[doc = "Default value if the importance level is not specified."]
        ImportanceLevelUnspecified,
        #[doc = "The given ranking expression is of Low importance in terms of job's\nfinal ranking position compared to existing relevance\nscore (determined by API algorithm)."]
        Low,
        #[doc = "The given ranking expression is of Medium importance in terms of job's\nfinal ranking position compared to existing relevance\nscore (determined by API algorithm)."]
        Medium,
        #[doc = "The given ranking expression is of Mild importance in terms of job's\nfinal ranking position compared to existing relevance\nscore (determined by API algorithm)."]
        Mild,
        #[doc = "The given ranking expression is of None importance, existing relevance\nscore (determined by API algorithm) dominates job's final ranking\nposition."]
        None,
    }
    ...
    pub struct HistogramQueryResult {
        #[doc = "A map from the values of the facet associated with distinct values to the\nnumber of matching entries with corresponding value.\n\nThe key format is:\n\n* (for string histogram) string values stored in the field.\n* (for named numeric bucket) name specified in `bucket()` function, like\n  for `bucket(0, MAX, \"non-negative\")`, the key will be `non-negative`.\n* (for anonymous numeric bucket) range formatted as `<low>-<high>`, for\n  example, `0-1000`, `MIN-0`, and `0-MAX`."]
        #[serde(
            rename = "histogram",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct SearchJobsResponse {
        ...
        #[doc = "The histogram results that match with specified\nSearchJobsRequest.histogram_queries."]
        #[serde(
