#![doc = "# Resources and Methods\n    * [operations](resources/operations/struct.OperationsActions.html)\n      * [*cancel*](resources/operations/struct.CancelRequestBuilder.html), [*delete*](resources/operations/struct.DeleteRequestBuilder.html), [*get*](resources/operations/struct.GetRequestBuilder.html), [*list*](resources/operations/struct.ListRequestBuilder.html)\n    * [services](resources/services/struct.ServicesActions.html)\n      * [*batchEnable*](resources/services/struct.BatchEnableRequestBuilder.html), [*batchGet*](resources/services/struct.BatchGetRequestBuilder.html), [*disable*](resources/services/struct.DisableRequestBuilder.html), [*enable*](resources/services/struct.EnableRequestBuilder.html), [*get*](resources/services/struct.GetRequestBuilder.html), [*list*](resources/services/struct.ListRequestBuilder.html)\n"]
pub mod scopes {
...
pub mod schemas {
    ...
    pub struct BatchGetServicesResponse {
        #[doc = "The requested Service states."]
        #[serde(
            rename = "services",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for BatchGetServicesResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for BatchGetServicesResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct DisableServiceRequest {
        ...
        #[serde(
            rename = "disableDependentServices",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
...
pub mod resources {
    ...
    pub mod services {
        ...
        #[doc = "Created via [ServicesActions::batch_get()](struct.ServicesActions.html#method.batch_get)"]
        #[derive(Debug, Clone)]
        ...
        impl<'a> BatchGetRequestBuilder<'a> {
            #[doc = "Names of the services to retrieve.\n\nAn example name would be:\n`projects/123/services/serviceusage.googleapis.com` where `123` is the\nproject number.\nA single request can get a maximum of 30 services at a time."]
            ...
            pub fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::BatchGetServicesResponse, crate::Error> {
                self.execute_with_fields(None::<&str>)
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            fn _path(&self) -> String {
                ...
                output.push_str("/services:batchGet");
                output
            }
            fn _request(
                &self,
        ...
        impl<'a> GetRequestBuilder<'a> {
            ...
            pub fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::GoogleApiServiceusageV1Service, crate::Error> {
                self.execute_with_fields(None::<&str>)
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
