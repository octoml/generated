...
pub mod schemas {
    ...
    impl ::google_field_selector::FieldSelector for ListAssetsResultStateChange {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListAssetsResultStateChange {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for ListFindingsResult {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for ListFindingsResultStateChange {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListFindingsResultStateChange {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct NotificationConfig {
        ...
        pub description: ::std::option::Option<String>,
        #[doc = "The type of events the config is for, e.g. FINDING."]
        #[serde(
            rename = "eventType",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub event_type: ::std::option::Option<crate::schemas::NotificationConfigEventType>,
    ...
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum NotificationConfigEventType {
        #[doc = "Unspecified event type."]
        EventTypeUnspecified,
        #[doc = "Events for findings."]
        Finding,
    }
    impl NotificationConfigEventType {
        pub fn as_str(self) -> &'static str {
            match self {
                NotificationConfigEventType::EventTypeUnspecified => "EVENT_TYPE_UNSPECIFIED",
                NotificationConfigEventType::Finding => "FINDING",
            }
        }
    }
    impl ::std::convert::AsRef<str> for NotificationConfigEventType {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for NotificationConfigEventType {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<NotificationConfigEventType, ()> {
            Ok(match s {
                "EVENT_TYPE_UNSPECIFIED" => NotificationConfigEventType::EventTypeUnspecified,
                "FINDING" => NotificationConfigEventType::Finding,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for NotificationConfigEventType {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for NotificationConfigEventType {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for NotificationConfigEventType {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for NotificationConfigEventType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for NotificationConfigEventType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
        ...
        pub mod assets {
            ...
            impl<'a> AssetsActions<'a> {
                ...
                pub fn update_security_marks(
                    &self,
                    request: crate::schemas::GoogleCloudSecuritycenterV1P1Beta1SecurityMarks,
                    name: impl Into<String>,
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                pub fn iter_list_assets_results<T>(self) -> crate::iter::PageItemIter<Self, T>
                where
                    T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
                {
                    let fields = ::google_field_selector::to_string::<T>();
                    ...
                    self.iter_list_assets_results_with_fields(fields)
                }
                #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                #[doc = r" fields in `#items_type` will be the default fields populated by"]
                #[doc = r" the server."]
                pub fn iter_list_assets_results_with_default_fields(
                    self,
                ) -> crate::iter::PageItemIter<Self, crate::schemas::ListAssetsResult>
                {
                    self.iter_list_assets_results_with_fields(None::<String>)
                }
                #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                ...
                #[doc = r" resources."]
                pub fn iter_list_assets_results_with_all_fields(
                    self,
                ) -> crate::iter::PageItemIter<Self, crate::schemas::ListAssetsResult>
                {
                    self.iter_list_assets_results_with_fields(Some("*"))
                }
                pub fn iter_list_assets_results_with_fields<T, F>(
                    mut self,
                    fields: Option<F>,
            ...
            impl<'a> UpdateSecurityMarksRequestBuilder<'a> {
                ...
                pub fn execute_with_default_fields(
                    ...
                    crate::schemas::GoogleCloudSecuritycenterV1P1Beta1SecurityMarks,
                    crate::Error,
                > {
                    self.execute_with_fields(None::<&str>)
                }
        ...
        pub mod sources {
            ...
            pub mod findings {
                ...
                impl<'a> FindingsActions<'a> {
                    ...
                    pub fn create(
                        &self,
                        request: crate::schemas::GoogleCloudSecuritycenterV1P1Beta1Finding,
                        parent: impl Into<String>,
                    ) -> CreateRequestBuilder {
                        CreateRequestBuilder {
                            reqwest: &self.reqwest,
                ...
                impl<'a> CreateRequestBuilder<'a> {
                    ...
                    pub fn execute_with_default_fields(
                        ...
                        crate::schemas::GoogleCloudSecuritycenterV1P1Beta1Finding,
                        crate::Error,
                    > {
                        self.execute_with_fields(None::<&str>)
                    }
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    #[doc = r" populated fields in the yielded items will be determined by the"]
                    #[doc = r" `FieldSelector` implementation."]
                    pub fn iter_list_findings_results<T>(self) -> crate::iter::PageItemIter<Self, T>
                    where
                        T: ::serde::de::DeserializeOwned + ::google_field_selector::FieldSelector,
                    {
                        let fields = ::google_field_selector::to_string::<T>();
                        ...
                        self.iter_list_findings_results_with_fields(fields)
                    }
                    #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                    #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                    #[doc = r" fields in `#items_type` will be the default fields populated by"]
                    #[doc = r" the server."]
                    pub fn iter_list_findings_results_with_default_fields(
                        self,
                    ) -> crate::iter::PageItemIter<Self, crate::schemas::ListFindingsResult>
                    {
                        self.iter_list_findings_results_with_fields(None::<String>)
                    }
                    #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
                    #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
                    #[doc = r" fields in `#items_type` will be all fields available. This should"]
                    ...
                    #[doc = r" all fields can be expensive both in bandwidth and server"]
                    #[doc = r" resources."]
                    pub fn iter_list_findings_results_with_all_fields(
                        self,
                    ) -> crate::iter::PageItemIter<Self, crate::schemas::ListFindingsResult>
                    {
                        self.iter_list_findings_results_with_fields(Some("*"))
                    }
                    pub fn iter_list_findings_results_with_fields<T, F>(
                        mut self,
                        fields: Option<F>,
                    ) -> crate::iter::PageItemIter<Self, T>
                    where
