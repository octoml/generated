...
pub mod scopes {
    ...
    #[doc = "Register and manage devices in the Google Cloud IoT service\n\n`https://www.googleapis.com/auth/cloudiot`"]
    pub const CLOUDIOT: &str = "https://www.googleapis.com/auth/cloudiot";
}
pub mod schemas {
    #[derive(
        Debug,
    ...
    impl ::google_field_selector::ToFieldType for BindDeviceToGatewayRequest {
    ...
    impl ::google_field_selector::ToFieldType for BindDeviceToGatewayResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::serde::Serialize for DeviceLogLevel {
    ...
    impl<'de> ::serde::Deserialize<'de> for DeviceLogLevel {
    ...
    impl ::google_field_selector::FieldSelector for DeviceLogLevel {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DeviceLogLevel {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for DeviceConfig {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DeviceConfig {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for DeviceCredential {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for DeviceRegistry {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DeviceRegistry {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl DeviceRegistryLogLevel {
        pub fn as_str(self) -> &'static str {
            match self {
                DeviceRegistryLogLevel::Debug => "DEBUG",
                DeviceRegistryLogLevel::Error => "ERROR",
                DeviceRegistryLogLevel::Info => "INFO",
    ...
    impl ::serde::Serialize for DeviceRegistryLogLevel {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for DeviceRegistryLogLevel {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for DeviceRegistryLogLevel {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DeviceRegistryLogLevel {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for EventNotificationConfig {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for GatewayConfig {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl GatewayConfigGatewayAuthMethod {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                GatewayConfigGatewayAuthMethod::AssociationOnly => "ASSOCIATION_ONLY",
                GatewayConfigGatewayAuthMethod::DeviceAuthTokenOnly => "DEVICE_AUTH_TOKEN_ONLY",
    ...
    impl ::serde::Serialize for GatewayConfigGatewayAuthMethod {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for GatewayConfigGatewayAuthMethod {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for GatewayConfigGatewayAuthMethod {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GatewayConfigGatewayAuthMethod {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum GatewayConfigGatewayType {
    ...
    impl GatewayConfigGatewayType {
        pub fn as_str(self) -> &'static str {
            match self {
                GatewayConfigGatewayType::Gateway => "GATEWAY",
                GatewayConfigGatewayType::GatewayTypeUnspecified => "GATEWAY_TYPE_UNSPECIFIED",
                GatewayConfigGatewayType::NonGateway => "NON_GATEWAY",
            }
        }
    }
    ...
    impl ::serde::Serialize for GatewayConfigGatewayType {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for GatewayConfigGatewayType {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for GatewayConfigGatewayType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GatewayConfigGatewayType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for HttpConfig {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum HttpConfigHttpEnabledState {
    ...
    impl HttpConfigHttpEnabledState {
        pub fn as_str(self) -> &'static str {
            match self {
                HttpConfigHttpEnabledState::HttpDisabled => "HTTP_DISABLED",
    ...
    impl ::serde::Serialize for HttpConfigHttpEnabledState {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for HttpConfigHttpEnabledState {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for HttpConfigHttpEnabledState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for HttpConfigHttpEnabledState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for ListDeviceConfigVersionsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for ListDeviceRegistriesResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for ListDeviceStatesResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for ModifyCloudToDeviceConfigRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ModifyCloudToDeviceConfigRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for MqttConfig {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl MqttConfigMqttEnabledState {
        pub fn as_str(self) -> &'static str {
            match self {
                MqttConfigMqttEnabledState::MqttDisabled => "MQTT_DISABLED",
    ...
    impl ::serde::Serialize for MqttConfigMqttEnabledState {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for MqttConfigMqttEnabledState {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for MqttConfigMqttEnabledState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for MqttConfigMqttEnabledState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for PublicKeyCertificate {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::serde::Serialize for PublicKeyCertificateFormat {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for PublicKeyCertificateFormat {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for PublicKeyCertificateFormat {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for PublicKeyCertificateFormat {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for PublicKeyCredential {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl PublicKeyCredentialFormat {
        pub fn as_str(self) -> &'static str {
            match self {
                PublicKeyCredentialFormat::Es256Pem => "ES256_PEM",
                PublicKeyCredentialFormat::Es256X509Pem => "ES256_X509_PEM",
                PublicKeyCredentialFormat::RsaPem => "RSA_PEM",
                PublicKeyCredentialFormat::RsaX509Pem => "RSA_X509_PEM",
    ...
    impl ::serde::Serialize for PublicKeyCredentialFormat {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for PublicKeyCredentialFormat {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for PublicKeyCredentialFormat {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for PublicKeyCredentialFormat {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for RegistryCredential {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for SendCommandToDeviceRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for SendCommandToDeviceResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for StateNotificationConfig {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for UnbindDeviceFromGatewayRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for UnbindDeviceFromGatewayResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for X509CertificateDetails {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub mod projects {
        ...
        pub mod locations {
            ...
            impl<'a> LocationsActions<'a> {
                ...
                #[doc = "Actions that can be performed on the registries resource"]
                pub fn registries(
                    &self,
                ) -> crate::resources::projects::locations::registries::RegistriesActions
                {
                    crate::resources::projects::locations::registries::RegistriesActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
            ...
            pub mod registries {
                pub mod params {}
                pub struct RegistriesActions<'a> {
                    pub(crate) reqwest: &'a reqwest::blocking::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                }
                impl<'a> RegistriesActions<'a> {
                    fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                        self.auth
                    }
                    #[doc = "Associates the device with the gateway."]
                    pub fn bind_device_to_gateway(
                        &self,
                        request: crate::schemas::BindDeviceToGatewayRequest,
                        parent: impl Into<String>,
                    ) -> BindDeviceToGatewayRequestBuilder {
                        BindDeviceToGatewayRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                            request,
                    ...
                    pub fn create(
                        &self,
                        request: crate::schemas::DeviceRegistry,
                        parent: impl Into<String>,
                    ...
                    pub fn unbind_device_from_gateway(
                        &self,
                        request: crate::schemas::UnbindDeviceFromGatewayRequest,
                        parent: impl Into<String>,
                    ) -> UnbindDeviceFromGatewayRequestBuilder {
                        UnbindDeviceFromGatewayRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                            request,
                    ...
                    pub fn devices(
                        &self,
                    ) -> crate::resources::projects::locations::registries::devices::DevicesActions
                    {
                        crate::resources::projects::locations::registries::devices::DevicesActions {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                    ...
                    pub fn groups(
                        &self,
                    ) -> crate::resources::projects::locations::registries::groups::GroupsActions
                    {
                        crate::resources::projects::locations::registries::groups::GroupsActions {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                ...
                impl<'a> BindDeviceToGatewayRequestBuilder<'a> {
                    ...
                    pub fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::BindDeviceToGatewayResponse, crate::Error>
                    {
                    ...
                    fn _path(&self) -> String {
                        let mut output = "https://cloudiot.googleapis.com/".to_owned();
                        output.push_str("v1/");
                        {
                ...
                impl<'a> CreateRequestBuilder<'a> {
                    ...
                    pub fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::DeviceRegistry, crate::Error> {
                        self.execute_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                    #[doc = r" selector of `*`. This will include every attribute of the"]
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    pub fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::ListDeviceRegistriesResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                impl<'a> UnbindDeviceFromGatewayRequestBuilder<'a> {
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        self.access_token = Some(value.into());
                        self
                    ...
                    pub fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::UnbindDeviceFromGatewayResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                pub mod devices {
                    pub mod params {
                        ...
                        impl ListGatewayListOptionsGatewayType {
                            pub fn as_str(self) -> &'static str {
                                match self {
                                    ListGatewayListOptionsGatewayType::Gateway => "GATEWAY",
                        ...
                        impl ::serde::Serialize for ListGatewayListOptionsGatewayType {
                            fn serialize<S>(
                                &self,
                                serializer: S,
                        ...
                        impl<'de> ::serde::Deserialize<'de> for ListGatewayListOptionsGatewayType {
                            fn deserialize<D>(
                                deserializer: D,
                        ...
                        impl ::google_field_selector::ToFieldType for ListGatewayListOptionsGatewayType {
                            fn field_type() -> ::google_field_selector::FieldType {
                                ::google_field_selector::FieldType::Leaf
                            }
                        }
                    ...
                    impl<'a> DevicesActions<'a> {
                        ...
                        pub fn list(&self, parent: impl Into<String>) -> ListRequestBuilder {
                            ListRequestBuilder {
                                ...
                                device_num_ids: None,
                                field_mask: None,
                                gateway_list_options_associations_device_id: None,
                                gateway_list_options_associations_gateway_id: None,
                                gateway_list_options_gateway_type: None,
                                page_size: None,
                                page_token: None,
                            }
                        }
                        ...
                        pub fn modify_cloud_to_device_config(
                            ...
                            name: impl Into<String>,
                        ) -> ModifyCloudToDeviceConfigRequestBuilder {
                            ModifyCloudToDeviceConfigRequestBuilder {
                                reqwest: &self.reqwest,
                                auth: self.auth_ref(),
                                request,
                        ...
                        pub fn send_command_to_device(
                            ...
                            name: impl Into<String>,
                        ) -> SendCommandToDeviceRequestBuilder {
                            SendCommandToDeviceRequestBuilder {
                                reqwest: &self.reqwest,
                                auth: self.auth_ref(),
                                request,
                    ...
                    #[derive(Debug, Clone)]
                    pub struct ListRequestBuilder < 'a > { pub ( crate ) reqwest : & 'a :: reqwest :: blocking :: Client , pub ( crate ) auth : & 'a dyn :: google_api_auth :: GetAccessToken , parent : String , device_ids : Option < Vec < String > > , device_num_ids : Option < Vec < u64 > > , field_mask : Option < String > , gateway_list_options_associations_device_id : Option < String > , gateway_list_options_associations_gateway_id : Option < String > , gateway_list_options_gateway_type : Option < crate :: resources :: projects :: locations :: registries :: devices :: params :: ListGatewayListOptionsGatewayType > , page_size : Option < i32 > , page_token : Option < String > , access_token : Option < String > , alt : Option < crate :: params :: Alt > , callback : Option < String > , fields : Option < String > , key : Option < String > , oauth_token : Option < String > , pretty_print : Option < bool > , quota_user : Option < String > , upload_protocol : Option < String > , upload_type : Option < String > , xgafv : Option < crate :: params :: Xgafv > , }
                    impl<'a> ListRequestBuilder<'a> {
                    ...
                    impl<'a> ModifyCloudToDeviceConfigRequestBuilder<'a> {
                        #[doc = "OAuth access token."]
                        pub fn access_token(mut self, value: impl Into<String>) -> Self {
                            self.access_token = Some(value.into());
                            self
                        ...
                        pub fn execute_with_default_fields(
                            self,
                        ) -> Result<crate::schemas::DeviceConfig, crate::Error>
                        {
                            self.execute_with_fields(None::<&str>)
                        }
                        #[doc = r" Execute the given operation. This will provide a `fields`"]
                    ...
                    impl<'a> SendCommandToDeviceRequestBuilder<'a> {
                        #[doc = "OAuth access token."]
                        pub fn access_token(mut self, value: impl Into<String>) -> Self {
                            self.access_token = Some(value.into());
                            self
                        ...
                        pub fn execute_with_default_fields(
                            self,
                        ) -> Result<crate::schemas::SendCommandToDeviceResponse, crate::Error>
                        {
                            self.execute_with_fields(None::<&str>)
                        }
                        #[doc = r" Execute the given operation. This will provide a `fields`"]
                    ...
                    pub mod config_versions {
                        pub mod params {}
                        pub struct ConfigVersionsActions<'a> {
                            pub(crate) reqwest: &'a reqwest::blocking::Client,
                            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                        }
                        impl<'a> ConfigVersionsActions<'a> {
                            fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                                self.auth
                            }
                        ...
                        impl<'a> ListRequestBuilder<'a> {
                            ...
                            pub fn execute_with_default_fields(
                                ...
                                crate::schemas::ListDeviceConfigVersionsResponse,
                                crate::Error,
                            > {
                                self.execute_with_fields(None::<&str>)
                            }
                    ...
                    pub mod states {
                        pub mod params {}
                        pub struct StatesActions<'a> {
                            pub(crate) reqwest: &'a reqwest::blocking::Client,
                            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                        }
                        impl<'a> StatesActions<'a> {
                            fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                                self.auth
                            }
                        ...
                        impl<'a> ListRequestBuilder<'a> {
                            ...
                            pub fn execute_with_default_fields(
                                self,
                            ) -> Result<crate::schemas::ListDeviceStatesResponse, crate::Error>
                            {
                                self.execute_with_fields(None::<&str>)
                            }
                            #[doc = r" Execute the given operation. This will provide a `fields`"]
