...
pub mod schemas {
    ...
    pub struct ApplyParametersRequest {
        #[doc = "Whether to apply instance-level parameter group to all nodes. If set to\ntrue, will explicitly restrict users from specifying any nodes, and apply\nparameter group updates to all nodes within the instance."]
        #[serde(
            rename = "applyAll",
            default,
        ...
        pub node_ids: ::std::option::Option<Vec<String>>,
    }
    impl ::google_field_selector::FieldSelector for ApplyParametersRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ApplyParametersRequest {
    ...
    pub struct GoogleCloudMemcacheV1Beta2LocationMetadata {
        ...
        pub available_zones: ::std::option::Option<
            ::std::collections::BTreeMap<String, crate::schemas::ZoneMetadata>,
        >,
    }
    impl ::google_field_selector::FieldSelector for GoogleCloudMemcacheV1Beta2LocationMetadata {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudMemcacheV1Beta2LocationMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for GoogleCloudMemcacheV1Beta2OperationMetadata {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleCloudMemcacheV1Beta2OperationMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl GoogleCloudSaasacceleratorManagementProvidersV1InstanceState {
        pub fn as_str(self) -> &'static str {
            match self {
                GoogleCloudSaasacceleratorManagementProvidersV1InstanceState::Creating => {
                    "CREATING"
                }
                ...
                GoogleCloudSaasacceleratorManagementProvidersV1InstanceState::StateUnspecified => {
                    "STATE_UNSPECIFIED"
                }
                GoogleCloudSaasacceleratorManagementProvidersV1InstanceState::Updating => {
                    "UPDATING"
                }
            }
        }
    }
    impl ::std::convert::AsRef<str> for GoogleCloudSaasacceleratorManagementProvidersV1InstanceState {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for GoogleCloudSaasacceleratorManagementProvidersV1InstanceState {
        type Err = ();
        fn from_str(
            s: &str,
        ) -> ::std::result::Result<GoogleCloudSaasacceleratorManagementProvidersV1InstanceState, ()>
        {
            Ok(match s {
                "CREATING" => {
                    GoogleCloudSaasacceleratorManagementProvidersV1InstanceState::Creating
    ...
    impl ::std::fmt::Display for GoogleCloudSaasacceleratorManagementProvidersV1InstanceState {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for GoogleCloudSaasacceleratorManagementProvidersV1InstanceState {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    pub struct GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSchedule {
        #[doc = "Can this scheduled update be rescheduled?\nBy default, it's true and API needs to do explicitly check whether it's\nset, if it's set as false explicitly, it's false"]
        #[serde(
    ...
    impl ::google_field_selector::FieldSelector
        for GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSchedule
    {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    ...
    pub struct GoogleCloudSaasacceleratorManagementProvidersV1NodeSloMetadata {
        #[doc = "By default node is eligible if instance is eligible.\nBut individual node might be excluded from SLO by adding entry here.\nFor semantic see SloMetadata.exclusions.\nIf both instance and node level exclusions are present for time period,\nthe node level's reason will be reported by Eligibility Exporter."]
        #[serde(
            rename = "exclusions",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct GoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource {
        ...
        #[doc = "URL identifying the resource, e.g.\n\"https://www.googleapis.com/compute/v1/projects/...)\"."]
        #[serde(
            rename = "resourceUrl",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector
        for GoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource
    {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    ...
    pub struct GoogleCloudSaasacceleratorManagementProvidersV1SloExclusion {
        ...
        pub reason: ::std::option::Option<String>,
        #[doc = "Name of an SLI that this exclusion applies to. Can be left empty,\nsignaling that the instance should be excluded from all SLIs defined\nin the service SLO configuration."]
        #[serde(
            rename = "sliName",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct GoogleCloudSaasacceleratorManagementProvidersV1SloMetadata {
        ...
        >,
        #[doc = "Name of the SLO tier the Instance belongs to. This name will be expected to\nmatch the tiers specified in the service SLO configuration.\n\nField is mandatory and must not be empty."]
        #[serde(
            rename = "tier",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector
        for GoogleCloudSaasacceleratorManagementProvidersV1SloMetadata
    {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    ...
    pub struct Instance {
        ...
        #[doc = "Optional. User provided name for the instance only used for display\npurposes. Cannot be more than 80 characters."]
        #[serde(
            rename = "displayName",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub instance_messages: ::std::option::Option<Vec<crate::schemas::InstanceMessage>>,
        #[doc = "Optional. Resource labels to represent user-provided metadata.\nRefer to cloud documentation on labels for more details.\nhttps://cloud.google.com/compute/docs/labeling-resources"]
        #[serde(
            rename = "labels",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub labels: ::std::option::Option<::std::collections::BTreeMap<String, String>>,
        #[doc = "Output only. The full version of memcached server running on this instance.\nSystem automatically determines the full memcached version for an instance\nbased on the input MemcacheVersion.\nThe full version format will be \"memcached-1.5.16\"."]
        #[serde(
        ...
        #[doc = "Output only. List of Memcached nodes.\nRefer to [Node] message for more details."]
        #[serde(
        ...
        #[doc = "Optional. The major version of Memcached software.\nIf not provided, latest supported version will be used. Currently the\nlatest supported major version is MEMCACHE_1_5.\nThe minor version will be automatically determined by our system based on\nthe latest supported minor version."]
        #[serde(
        ...
        #[doc = "Optional: User defined parameters to apply to the memcached process\non each node."]
        #[serde(
            rename = "parameters",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub parameters: ::std::option::Option<crate::schemas::MemcacheParameters>,
        ...
        pub update_time: ::std::option::Option<String>,
        #[doc = "Optional. Zones where Memcached nodes should be provisioned in.\nMemcached nodes will be equally distributed across these zones. If not\nprovided, the service will by default create nodes in all zones in the\nregion for the instance."]
        #[serde(
            rename = "zones",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum InstanceMemcacheVersion {
        #[doc = "Memcached 1.5 version."]
        Memcache15,
        MemcacheVersionUnspecified,
    }
    impl InstanceMemcacheVersion {
        pub fn as_str(self) -> &'static str {
            match self {
                InstanceMemcacheVersion::Memcache15 => "MEMCACHE_1_5",
                InstanceMemcacheVersion::MemcacheVersionUnspecified => {
                    "MEMCACHE_VERSION_UNSPECIFIED"
                }
            }
        }
    }
    impl ::std::convert::AsRef<str> for InstanceMemcacheVersion {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for InstanceMemcacheVersion {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<InstanceMemcacheVersion, ()> {
            Ok(match s {
                "MEMCACHE_1_5" => InstanceMemcacheVersion::Memcache15,
                "MEMCACHE_VERSION_UNSPECIFIED" => {
                    InstanceMemcacheVersion::MemcacheVersionUnspecified
                }
                _ => return Err(()),
    ...
    impl ::std::fmt::Display for InstanceMemcacheVersion {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for InstanceMemcacheVersion {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for InstanceMemcacheVersion {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for InstanceMemcacheVersion {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for InstanceMemcacheVersion {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct InstanceMessage {
        ...
        pub code: ::std::option::Option<crate::schemas::InstanceMessageCode>,
    ...
    impl ::google_field_selector::FieldSelector for InstanceMessage {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for InstanceMessage {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum InstanceMessageCode {
        #[doc = "Message Code not set."]
        CodeUnspecified,
        #[doc = "Memcached nodes are distributed unevenly."]
        ZoneDistributionUnbalanced,
    }
    impl InstanceMessageCode {
        pub fn as_str(self) -> &'static str {
            match self {
                InstanceMessageCode::CodeUnspecified => "CODE_UNSPECIFIED",
                InstanceMessageCode::ZoneDistributionUnbalanced => "ZONE_DISTRIBUTION_UNBALANCED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for InstanceMessageCode {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for InstanceMessageCode {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<InstanceMessageCode, ()> {
            Ok(match s {
                "CODE_UNSPECIFIED" => InstanceMessageCode::CodeUnspecified,
                "ZONE_DISTRIBUTION_UNBALANCED" => InstanceMessageCode::ZoneDistributionUnbalanced,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for InstanceMessageCode {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for InstanceMessageCode {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for InstanceMessageCode {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for InstanceMessageCode {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for InstanceMessageCode {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ListInstancesResponse {
        ...
        #[doc = "A list of Memcached instances in the project in the specified location,\nor across all locations.\n\nIf the `location_id` in the parent field of the request is \"-\", all regions\navailable to the project are queried, and the results aggregated."]
        #[serde(
            rename = "resources",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub resources: ::std::option::Option<Vec<crate::schemas::Instance>>,
    ...
    impl ::google_field_selector::FieldSelector for MemcacheParameters {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for MemcacheParameters {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct Node {
        #[doc = "Output only. Hostname or IP address of the Memcached node used by the\nclients to connect to the Memcached server on this node."]
        #[serde(
            rename = "host",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Output only. Identifier of the Memcached node. The node id does not\ninclude project or location like the Memcached instance name."]
        #[serde(
            rename = "nodeId",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct NodeConfig {
        ...
        pub memory_size_mb: ::std::option::Option<i32>,
    }
    ...
    impl ::google_field_selector::FieldSelector for UpdateParametersRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for UpdateParametersRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for ZoneMetadata {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ZoneMetadata {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
        ...
        pub mod locations {
            ...
            impl<'a> GetRequestBuilder<'a> {
                ...
                fn _path(&self) -> String {
                    let mut output = "https://memcache.googleapis.com/".to_owned();
            ...
            pub mod instances {
                ...
                impl<'a> InstancesActions<'a> {
                    ...
                    pub fn update_parameters(
                        ...
                        name: impl Into<String>,
                    ) -> UpdateParametersRequestBuilder {
                        UpdateParametersRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                            request,
                ...
                #[doc = "Created via [InstancesActions::apply_parameters()](struct.InstancesActions.html#method.apply_parameters)"]
                #[derive(Debug, Clone)]
                pub struct ApplyParametersRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::blocking::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    request: crate::schemas::ApplyParametersRequest,
                    name: String,
                ...
                impl<'a> ApplyParametersRequestBuilder<'a> {
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        self.access_token = Some(value.into());
                        self
                    ...
                    fn _path(&self) -> String {
                        ...
                        output.push_str(":applyParameters");
                        output
                    }
                    fn _request(
                        &self,
                ...
                impl<'a> CreateRequestBuilder<'a> {
                    #[doc = "Required. The logical name of the Memcached instance in the user\nproject with the following restrictions:\n\n* Must contain only lowercase letters, numbers, and hyphens.\n* Must start with a letter.\n* Must be between 1-40 characters.\n* Must end with a number or a letter.\n* Must be unique within the user project / location"]
                ...
                impl<'a> ListRequestBuilder<'a> {
                    #[doc = "List filter. For example, exclude all Memcached instances with name as\nmy-instance by specifying \"name != my-instance\"."]
                    pub fn filter(mut self, value: impl Into<String>) -> Self {
                        self.filter = Some(value.into());
                        self
                    }
                ...
                #[doc = "Created via [InstancesActions::update_parameters()](struct.InstancesActions.html#method.update_parameters)"]
                #[derive(Debug, Clone)]
                pub struct UpdateParametersRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::blocking::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    request: crate::schemas::UpdateParametersRequest,
                    name: String,
                ...
                impl<'a> UpdateParametersRequestBuilder<'a> {
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        self.access_token = Some(value.into());
                        self
                    ...
                    fn _path(&self) -> String {
                        ...
                        output.push_str(":updateParameters");
                        output
                    }
                    fn _request(
                        &self,
