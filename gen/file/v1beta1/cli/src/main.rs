...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        ...
        {
            let mcmd = SubCommand::with_name("create").about("Creates an instance.");
        ...
        {
            let mcmd =
                SubCommand::with_name("get").about("Gets the details of a specific instance.");
            instances2 = instances2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list").about("Lists all instances in a project for either a specified location\nor for all locations.");
            instances2 = instances2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("patch")
                .about("Updates the settings of a specific instance.");
            instances2 = instances2.subcommand(mcmd);
        }
