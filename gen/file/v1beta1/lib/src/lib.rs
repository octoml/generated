...
pub mod schemas {
    ...
    impl ::google_field_selector::FieldSelector for BillingView {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for BillingView {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct FileShareConfig {
        #[doc = "File share capacity in gigabytes (GB).\nCloud Filestore defines 1 GB as 1024^3 bytes."]
        #[serde(
            rename = "capacityGb",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[serde(with = "crate::parsed_string")]
        pub capacity_gb: ::std::option::Option<i64>,
    ...
    impl ::google_field_selector::FieldSelector for FileShareConfig {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for FileShareConfig {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct GoogleApiServicecontrolV1Operation {
        ...
        pub importance:
            ::std::option::Option<crate::schemas::GoogleApiServicecontrolV1OperationImportance>,
    ...
    impl ::google_field_selector::FieldSelector for GoogleApiServicecontrolV1Operation {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleApiServicecontrolV1Operation {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum GoogleApiServicecontrolV1OperationImportance {
    ...
    impl GoogleApiServicecontrolV1OperationImportance {
        pub fn as_str(self) -> &'static str {
            match self {
                GoogleApiServicecontrolV1OperationImportance::Debug => "DEBUG",
                GoogleApiServicecontrolV1OperationImportance::High => "HIGH",
                GoogleApiServicecontrolV1OperationImportance::Low => "LOW",
            }
        }
    }
    impl ::std::convert::AsRef<str> for GoogleApiServicecontrolV1OperationImportance {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for GoogleApiServicecontrolV1OperationImportance {
        type Err = ();
        fn from_str(
            s: &str,
        ) -> ::std::result::Result<GoogleApiServicecontrolV1OperationImportance, ()> {
            Ok(match s {
                "DEBUG" => GoogleApiServicecontrolV1OperationImportance::Debug,
                "HIGH" => GoogleApiServicecontrolV1OperationImportance::High,
                "LOW" => GoogleApiServicecontrolV1OperationImportance::Low,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for GoogleApiServicecontrolV1OperationImportance {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for GoogleApiServicecontrolV1OperationImportance {
    ...
    impl<'de> ::serde::Deserialize<'de> for GoogleApiServicecontrolV1OperationImportance {
    ...
    impl ::google_field_selector::FieldSelector for GoogleApiServicecontrolV1OperationImportance {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for GoogleApiServicecontrolV1OperationImportance {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings {
        #[doc = "Optional. Exclude instance from maintenance. When true, rollout service will not\nattempt maintenance on the instance. Rollout service will include the\ninstance in reported rollout progress as not attempted."]
        #[serde(
            rename = "exclude",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub exclude: ::std::option::Option<bool>,
    }
    impl ::google_field_selector::FieldSelector
        for GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings
    {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    ...
    pub enum InstanceState {
        ...
        Deleting,
        #[doc = "The instance is experiencing an issue and might be unusable. You can get\nfurther details from the `statusMessage` field of the `Instance`\nresource."]
        Error,
        #[doc = "The instance is available for use."]
        Ready,
        #[doc = "Work is being done on the instance. You can get further details from the\n`statusMessage` field of the `Instance` resource."]
        Repairing,
        #[doc = "The instance is restoring a snapshot or backup to an existing file share\nand may be unusable during this time."]
        Restoring,
        #[doc = "State not set."]
        StateUnspecified,
    }
    impl InstanceState {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                InstanceState::Restoring => "RESTORING",
    ...
    impl ::google_field_selector::FieldSelector for InstanceTier {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for InstanceTier {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ListInstancesResponse {
        ...
        #[doc = "The token you can use to retrieve the next page of results. Not returned\nif there are no more results in the list."]
        #[serde(
    ...
    impl NetworkConfigModesItems {
        pub fn as_str(self) -> &'static str {
            match self {
                NetworkConfigModesItems::AddressModeUnspecified => "ADDRESS_MODE_UNSPECIFIED",
                NetworkConfigModesItems::ModeIpv4 => "MODE_IPV4",
            }
        }
    }
    impl ::std::convert::AsRef<str> for NetworkConfigModesItems {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for NetworkConfigModesItems {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<NetworkConfigModesItems, ()> {
            Ok(match s {
                "ADDRESS_MODE_UNSPECIFIED" => NetworkConfigModesItems::AddressModeUnspecified,
                "MODE_IPV4" => NetworkConfigModesItems::ModeIpv4,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for NetworkConfigModesItems {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for NetworkConfigModesItems {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for NetworkConfigModesItems {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for NetworkConfigModesItems {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for NetworkConfigModesItems {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct ReportRequest {
        ...
        pub operations:
            ::std::option::Option<Vec<crate::schemas::GoogleApiServicecontrolV1Operation>>,
        ...
        #[doc = "The service name as specified in its service configuration. For example,\n`\"pubsub.googleapis.com\"`.\n\nSee\n[google.api.Service](https://cloud.google.com/service-management/reference/rpc/google.api#google.api.Service)\nfor the definition of a service name."]
        #[serde(
            rename = "serviceName",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub mod locations {
            ...
            impl<'a> GetRequestBuilder<'a> {
                ...
                fn _path(&self) -> String {
                    let mut output = "https://file.googleapis.com/".to_owned();
            ...
            pub mod instances {
                ...
                impl<'a> PatchRequestBuilder<'a> {
                    #[doc = "Required. Mask of fields to update.  At least one path must be supplied in this\nfield.  The elements of the repeated paths field may only include these\nfields:\n\n* \"description\"\n* \"file_shares\"\n* \"labels\""]
