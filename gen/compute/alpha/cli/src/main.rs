...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        ...
        let mut addresses0 = SubCommand::with_name("addresses")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: aggregated_list, delete, get, insert, list, set_labels and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("aggregated_list")
        ...
        {
            let mcmd = SubCommand::with_name("set_labels").about("Sets the labels on an Address. To learn more about labels, read the Labeling Resources documentation.");
            addresses0 = addresses0.subcommand(mcmd);
        }
        {
        ...
        let mut autoscalers0 = SubCommand::with_name("autoscalers")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: aggregated_list, delete, get, insert, list, patch, test_iam_permissions and update");
        {
            let mcmd = SubCommand::with_name("aggregated_list")
        ...
        let mut backend_buckets0 = SubCommand::with_name("backend_buckets")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: add_signed_url_key, delete, delete_signed_url_key, get, get_iam_policy, insert, list, patch, set_iam_policy, test_iam_permissions and update");
        {
        ...
        let mut backend_services0 = SubCommand::with_name("backend_services")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: add_signed_url_key, aggregated_list, delete, delete_signed_url_key, get, get_health, insert, list, patch, set_security_policy, test_iam_permissions and update");
        {
            let mcmd = SubCommand::with_name("add_signed_url_key").about(
        ...
        let mut firewalls0 = SubCommand::with_name("firewalls")
            .setting(AppSettings::ColoredHelp)
            .about("methods: delete, get, insert, list, patch, test_iam_permissions and update");
        {
        ...
        let mut forwarding_rules0 = SubCommand::with_name("forwarding_rules")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: aggregated_list, delete, get, insert, list, patch, set_labels, set_target and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("aggregated_list")
        ...
        {
            let mcmd = SubCommand::with_name("set_labels").about("Sets the labels on a GlobalAddress. To learn more about labels, read the Labeling Resources documentation.");
            global_addresses0 = global_addresses0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("test_iam_permissions")
        ...
        let mut global_forwarding_rules0 = SubCommand::with_name("global_forwarding_rules")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: delete, get, insert, list, patch, set_labels, set_target and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("delete")
        ...
        let mut global_organization_operations0 =
            SubCommand::with_name("global_organization_operations")
                .setting(AppSettings::ColoredHelp)
                .about("methods: delete, get and list");
        {
            let mcmd =
                SubCommand::with_name("delete").about("Deletes the specified Operations resource.");
            global_organization_operations0 = global_organization_operations0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get").about("Retrieves the specified Operations resource. Gets a list of operations by making a `list()` request.");
            global_organization_operations0 = global_organization_operations0.subcommand(mcmd);
        ...
        {
            let mcmd = SubCommand::with_name("list").about("Retrieves a list of Operation resources contained within the specified organization.");
            global_organization_operations0 = global_organization_operations0.subcommand(mcmd);
        }
        let mut global_public_delegated_prefixes0 =
            SubCommand::with_name("global_public_delegated_prefixes")
                .setting(AppSettings::ColoredHelp)
                .about("methods: delete, get, insert, list and patch");
        {
            let mcmd = SubCommand::with_name("delete")
                .about("Deletes the specified global PublicDelegatedPrefix.");
            global_public_delegated_prefixes0 = global_public_delegated_prefixes0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get")
                .about("Returns the specified global PublicDelegatedPrefix resource.");
            global_public_delegated_prefixes0 = global_public_delegated_prefixes0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("insert").about("Creates a global PublicDelegatedPrefix in the specified project using the parameters that are included in the request.");
            global_public_delegated_prefixes0 = global_public_delegated_prefixes0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list")
                .about("Lists the global PublicDelegatedPrefixes for a project.");
            global_public_delegated_prefixes0 = global_public_delegated_prefixes0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("patch").about("Patches the specified global PublicDelegatedPrefix resource with the data included in the request. This method supports PATCH semantics and uses JSON merge patch format and processing rules.");
            global_public_delegated_prefixes0 = global_public_delegated_prefixes0.subcommand(mcmd);
        }
        ...
        {
            let mcmd = SubCommand::with_name("patch").about("Patches the specified image with the data included in the request. Only the following fields can be modified: family, description, deprecation status.");
            images0 = images0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("set_iam_policy").about("Sets the access control policy on the specified resource. Replaces any existing policy.");
        ...
        let mut instance_group_managers0 = SubCommand::with_name("instance_group_managers")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: abandon_instances, aggregated_list, apply_updates_to_instances, create_instances, delete, delete_instances, delete_per_instance_configs, get, insert, list, list_errors, list_managed_instances, list_per_instance_configs, patch, patch_per_instance_configs, recreate_instances, resize, resize_advanced, set_auto_healing_policies, set_instance_template, set_target_pools, test_iam_permissions, update and update_per_instance_configs");
        {
        ...
        {
            let mcmd = SubCommand::with_name("list_per_instance_configs").about(
        ...
        {
            let mcmd = SubCommand::with_name("resize_advanced").about("Resizes the managed instance group with advanced configuration options like disabling creation retries. This is an extended version of the resize method.\n\nIf you increase the size of the instance group, the group creates new instances using the current instance template. If you decrease the size, the group deletes instances. The resize operation is marked DONE when the resize actions are scheduled even if the group has not yet added or deleted any instances. You must separately verify the status of the creating, creatingWithoutRetries, or deleting actions with the get or listmanagedinstances method.\n\nIf the group is part of a backend service that has enabled connection draining, it can take up to 60 seconds after the connection draining duration has elapsed before the VM instance is removed or deleted.");
            instance_group_managers0 = instance_group_managers0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("set_auto_healing_policies").about("Modifies the autohealing policies. [Deprecated] This method is deprecated. Please use Patch instead.");
            instance_group_managers0 = instance_group_managers0.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("update").about("Updates a managed instance group using the information that you specify in the request. This operation is marked as DONE when the group is updated even if the instances in the group have not yet been updated. You must separately verify the status of the individual instances with the listManagedInstances method.");
            instance_group_managers0 = instance_group_managers0.subcommand(mcmd);
        }
        {
        ...
        let mut instance_groups0 = SubCommand::with_name("instance_groups")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: add_instances, aggregated_list, delete, get, insert, list, list_instances, remove_instances, set_named_ports and test_iam_permissions");
        {
        ...
        let mut instances0 = SubCommand::with_name("instances")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: add_access_config, add_resource_policies, aggregated_list, attach_disk, bulk_insert, delete, delete_access_config, detach_disk, get, get_effective_firewalls, get_guest_attributes, get_iam_policy, get_screenshot, get_serial_port_output, get_shielded_instance_identity, get_shielded_vm_identity, insert, list, list_referrers, remove_resource_policies, reset, resume, set_deletion_protection, set_disk_auto_delete, set_iam_policy, set_labels, set_machine_resources, set_machine_type, set_metadata, set_min_cpu_platform, set_name, set_scheduling, set_service_account, set_shielded_instance_integrity_policy, set_shielded_vm_integrity_policy, set_tags, simulate_maintenance_event, start, start_with_encryption_key, stop, suspend, test_iam_permissions, update, update_access_config, update_display_device, update_network_interface, update_shielded_instance_config and update_shielded_vm_config");
        {
        ...
        {
            let mcmd = SubCommand::with_name("bulk_insert").about(
        ...
        }
        {
            let mcmd = SubCommand::with_name("get_effective_firewalls")
                .about("Returns effective firewalls applied to an interface of the instance.");
            instances0 = instances0.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("get_screenshot")
                .about("Returns the screenshot from the specified instance.");
            instances0 = instances0.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("get_shielded_vm_identity")
                .about("Returns the Shielded VM Identity of an instance");
            instances0 = instances0.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("set_name").about("Sets name of an instance.");
            instances0 = instances0.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("set_shielded_vm_integrity_policy").about("Sets the Shielded VM integrity policy for a VM instance. You can only use this method on a running VM instance. This method supports PATCH semantics and uses the JSON merge patch format and processing rules.");
            instances0 = instances0.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("suspend").about("This method suspends a running instance, saving its state to persistent storage, and allows you to resume the instance at a later time. Suspended instances incur reduced per-minute, virtual machine usage charges while they are suspended. Any resources the virtual machine is using, such as persistent disks and static IP addresses, will continue to be charged until they are deleted.");
            instances0 = instances0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("test_iam_permissions")
        ...
        {
            let mcmd = SubCommand::with_name("update_shielded_vm_config").about("Updates the Shielded VM config for a VM instance. You can only use this method on a stopped VM instance. This method supports PATCH semantics and uses the JSON merge patch format and processing rules.");
            instances0 = instances0.subcommand(mcmd);
        }
        let mut interconnect_attachments0 = SubCommand::with_name("interconnect_attachments")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: aggregated_list, delete, get, get_iam_policy, insert, list, patch, set_iam_policy, set_labels and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("aggregated_list")
        ...
        {
            let mcmd = SubCommand::with_name("set_labels").about("Sets the labels on an InterconnectAttachment. To learn more about labels, read the Labeling Resources documentation.");
            interconnect_attachments0 = interconnect_attachments0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("test_iam_permissions")
        ...
        let mut interconnect_locations0 = SubCommand::with_name("interconnect_locations")
            .setting(AppSettings::ColoredHelp)
            .about("methods: get, list and test_iam_permissions");
        {
        ...
        let mut interconnects0 = SubCommand::with_name("interconnects")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: delete, get, get_diagnostics, get_iam_policy, insert, list, patch, set_iam_policy, set_labels and test_iam_permissions");
        {
        ...
        {
            let mcmd = SubCommand::with_name("set_labels").about("Sets the labels on an Interconnect. To learn more about labels, read the Labeling Resources documentation.");
            interconnects0 = interconnects0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("test_iam_permissions")
        ...
        let mut license_codes0 = SubCommand::with_name("license_codes")
            .setting(AppSettings::ColoredHelp)
            .about("methods: get, get_iam_policy, set_iam_policy and test_iam_permissions");
        {
        ...
        let mut networks0 = SubCommand::with_name("networks")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: add_peering, delete, get, get_effective_firewalls, insert, list, list_ip_addresses, list_ip_owners, list_peering_routes, patch, remove_peering, switch_to_custom_mode, test_iam_permissions and update_peering");
        {
        ...
        {
            let mcmd = SubCommand::with_name("list_ip_addresses")
                .about("Lists the internal IP addresses in the specified network.");
            networks0 = networks0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list_ip_owners")
                .about("Lists the internal IP owners in the specified network.");
            networks0 = networks0.subcommand(mcmd);
        }
        {
        ...
        let mut organization_security_policies0 = SubCommand::with_name("organization_security_policies")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: add_association, add_rule, copy_rules, delete, get, get_association, get_rule, insert, list, list_associations, r#move, patch, patch_rule, remove_association and remove_rule");
        {
            let mcmd = SubCommand::with_name("add_association")
                .about("Inserts an association for the specified security policy.");
            organization_security_policies0 = organization_security_policies0.subcommand(mcmd);
        }
        {
            let mcmd =
        ...
        {
            let mcmd = SubCommand::with_name("copy_rules")
                .about("Copies rules to the specified security policy.");
            organization_security_policies0 = organization_security_policies0.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("list_associations")
                .about("Lists associations of a specified target, i.e., organization or folder.");
            organization_security_policies0 = organization_security_policies0.subcommand(mcmd);
        }
        {
            let mcmd =
                SubCommand::with_name("r#move").about("Moves the specified security policy.");
            organization_security_policies0 = organization_security_policies0.subcommand(mcmd);
        }
        {
        ...
        }
        {
            let mcmd = SubCommand::with_name("remove_association")
                .about("Removes an association for the specified security policy.");
            organization_security_policies0 = organization_security_policies0.subcommand(mcmd);
        }
        {
        ...
        let mut projects0 = SubCommand::with_name("projects")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: disable_xpn_host, disable_xpn_resource, enable_xpn_host, enable_xpn_resource, get, get_xpn_host, get_xpn_resources, list_xpn_hosts, move_disk, move_instance, set_common_instance_metadata, set_default_network_tier, set_default_service_account and set_usage_export_bucket");
        {
        ...
        {
            let mcmd = SubCommand::with_name("set_default_service_account").about("Sets the default service account of the project. The default service account is used when a VM instance is created with the service account email address set to \"default\".");
            projects0 = projects0.subcommand(mcmd);
        }
        {
        ...
        let mut public_advertised_prefixes0 = SubCommand::with_name("public_advertised_prefixes")
            .setting(AppSettings::ColoredHelp)
            .about("methods: delete, get, insert, list and patch");
        {
            let mcmd = SubCommand::with_name("delete")
                .about("Deletes the specified PublicAdvertisedPrefix");
            public_advertised_prefixes0 = public_advertised_prefixes0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get")
                .about("Returns the specified PublicAdvertisedPrefix resource.");
            public_advertised_prefixes0 = public_advertised_prefixes0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("insert").about("Creates a PublicAdvertisedPrefix in the specified project using the parameters that are included in the request.");
            public_advertised_prefixes0 = public_advertised_prefixes0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list")
                .about("Lists the PublicAdvertisedPrefixes for a project.");
            public_advertised_prefixes0 = public_advertised_prefixes0.subcommand(mcmd);
        }
        {
        ...
        let mut public_delegated_prefixes0 = SubCommand::with_name("public_delegated_prefixes")
            .setting(AppSettings::ColoredHelp)
            .about("methods: aggregated_list, delete, get, insert, list and patch");
        {
            let mcmd = SubCommand::with_name("aggregated_list").about("Lists all PublicDelegatedPrefix resources owned by the specific project across all scopes.");
            public_delegated_prefixes0 = public_delegated_prefixes0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("delete")
                .about("Deletes the specified PublicDelegatedPrefix in the given region.");
            public_delegated_prefixes0 = public_delegated_prefixes0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get")
                .about("Returns the specified PublicDelegatedPrefix resource in the given region.");
            public_delegated_prefixes0 = public_delegated_prefixes0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("insert").about("Creates a PublicDelegatedPrefix in the specified project in the given region using the parameters that are included in the request.");
            public_delegated_prefixes0 = public_delegated_prefixes0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list")
                .about("Lists the PublicDelegatedPrefixes for a project in the given region.");
            public_delegated_prefixes0 = public_delegated_prefixes0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("patch").about("Patches the specified PublicDelegatedPrefix resource with the data included in the request. This method supports PATCH semantics and uses JSON merge patch format and processing rules.");
            public_delegated_prefixes0 = public_delegated_prefixes0.subcommand(mcmd);
        }
        ...
        let mut region_backend_services0 = SubCommand::with_name("region_backend_services")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: delete, get, get_health, insert, list, patch, test_iam_permissions and update");
        {
            let mcmd = SubCommand::with_name("delete")
        ...
        let mut region_commitments0 = SubCommand::with_name("region_commitments")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: aggregated_list, get, insert, list, test_iam_permissions and update_reservations");
        {
            let mcmd = SubCommand::with_name("aggregated_list")
        ...
        {
            let mcmd = SubCommand::with_name("update_reservations")
                .about("Transfers GPUs or local SSDs between reservations within commitments.");
            region_commitments0 = region_commitments0.subcommand(mcmd);
        }
        ...
        let mut region_in_place_snapshots0 = SubCommand::with_name("region_in_place_snapshots")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: delete, get, get_iam_policy, insert, list, set_iam_policy, set_labels and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("delete").about("Deletes the specified InPlaceSnapshot resource. Keep in mind that deleting a single inPlaceSnapshot might not necessarily delete all the data on that inPlaceSnapshot. If any data on the inPlaceSnapshot that is marked for deletion is needed for subsequent inPlaceSnapshots, the data will be moved to the next corresponding inPlaceSnapshot.\n\nFor more information, see Deleting inPlaceSnapshots.");
            region_in_place_snapshots0 = region_in_place_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get")
                .about("Returns the specified InPlaceSnapshot resource in the specified region.");
            region_in_place_snapshots0 = region_in_place_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get_iam_policy").about("Gets the access control policy for a resource. May be empty if no such policy or resource exists.");
        ...
        }
        {
            let mcmd = SubCommand::with_name("insert")
                .about("Creates an in-place snapshot in the specified region.");
            region_in_place_snapshots0 = region_in_place_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list").about("Retrieves the list of InPlaceSnapshot resources contained within the specified region.");
            region_in_place_snapshots0 = region_in_place_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("set_iam_policy").about("Sets the access control policy on the specified resource. Replaces any existing policy.");
        ...
        {
            let mcmd = SubCommand::with_name("set_labels").about("Sets the labels on a inPlaceSnapshot in the given region. To learn more about labels, read the Labeling Resources documentation.");
            region_in_place_snapshots0 = region_in_place_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("test_iam_permissions")
        ...
        let mut region_instance_group_managers0 = SubCommand::with_name("region_instance_group_managers")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: abandon_instances, apply_updates_to_instances, create_instances, delete, delete_instances, delete_per_instance_configs, get, insert, list, list_errors, list_managed_instances, list_per_instance_configs, patch, patch_per_instance_configs, recreate_instances, resize, set_auto_healing_policies, set_instance_template, set_target_pools, test_iam_permissions, update and update_per_instance_configs");
        {
        ...
        {
            let mcmd = SubCommand::with_name("patch_per_instance_configs").about("Insert or patch (for the ones that already exist) per-instance configs for the managed instance group. perInstanceConfig.instance serves as a key used to distinguish whether to perform insert or patch.");
            region_instance_group_managers0 = region_instance_group_managers0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("recreate_instances").about("Flags the specified instances in the managed instance group to be immediately recreated. The instances are deleted and recreated using the current instance template for the managed instance group. This operation is marked as DONE when the flag is set even if the instances have not yet been recreated. You must separately verify the status of the recreating action with the listmanagedinstances method.\n\nIf the group is part of a backend service that has enabled connection draining, it can take up to 60 seconds after the connection draining duration has elapsed before the VM instance is removed or deleted.\n\nYou can specify a maximum of 1000 instances with this method per request.");
        ...
        {
            let mcmd = SubCommand::with_name("set_auto_healing_policies").about("Modifies the autohealing policy for the instances in this managed instance group. [Deprecated] This method is deprecated. Please use Patch instead.");
            region_instance_group_managers0 = region_instance_group_managers0.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("update_per_instance_configs").about("Insert or update (for the ones that already exist) per-instance configs for the managed instance group. perInstanceConfig.instance serves as a key used to distinguish whether to perform insert or patch.");
            region_instance_group_managers0 = region_instance_group_managers0.subcommand(mcmd);
        }
        let mut region_instance_groups0 = SubCommand::with_name("region_instance_groups")
            .setting(AppSettings::ColoredHelp)
            .about("methods: get, list, list_instances, set_named_ports and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("get")
        ...
        let mut region_instances0 = SubCommand::with_name("region_instances")
            .setting(AppSettings::ColoredHelp)
            .about("methods: bulk_insert");
        {
            let mcmd = SubCommand::with_name("bulk_insert").about("Creates multiple instances in a given region. Count specifies the number of instances to create.");
            region_instances0 = region_instances0.subcommand(mcmd);
        }
        ...
        let mut region_target_http_proxies0 = SubCommand::with_name("region_target_http_proxies")
            .setting(AppSettings::ColoredHelp)
            .about("methods: delete, get, insert, list, set_url_map and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("delete")
        ...
        let mut region_target_https_proxies0 = SubCommand::with_name("region_target_https_proxies")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: delete, get, insert, list, set_ssl_certificates, set_url_map and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("delete")
        ...
        let mut region_url_maps0 = SubCommand::with_name("region_url_maps")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: delete, get, insert, invalidate_cache, list, patch, test_iam_permissions, update and validate");
        {
            let mcmd =
        ...
        let mut routers0 = SubCommand::with_name("routers")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: aggregated_list, delete, get, get_nat_mapping_info, get_router_status, insert, list, patch, preview, test_iam_permissions and update");
        {
            let mcmd = SubCommand::with_name("aggregated_list")
        ...
        let mut security_policies0 = SubCommand::with_name("security_policies")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: add_rule, delete, get, get_rule, insert, list, list_preconfigured_expression_sets, patch, patch_rule, remove_rule, set_labels and test_iam_permissions");
        {
            let mcmd =
                SubCommand::with_name("add_rule").about("Inserts a rule into a security policy.");
        ...
        {
            let mcmd = SubCommand::with_name("set_labels").about("Sets the labels on a security policy. To learn more about labels, read the Labeling Resources documentation.");
            security_policies0 = security_policies0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("test_iam_permissions")
        ...
        let mut ssl_certificates0 = SubCommand::with_name("ssl_certificates")
            .setting(AppSettings::ColoredHelp)
            .about("methods: aggregated_list, delete, get, insert, list and test_iam_permissions");
        {
        ...
        let mut ssl_policies0 = SubCommand::with_name("ssl_policies")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: delete, get, insert, list, list_available_features, patch and test_iam_permissions");
        {
        ...
        {
            let mcmd = SubCommand::with_name("get")
                .about("Returns the specified TargetGrpcProxy resource in the given scope.");
            target_grpc_proxies0 = target_grpc_proxies0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("insert").about("Creates a TargetGrpcProxy in the specified project in the given scope using the parameters that are included in the request.");
            target_grpc_proxies0 = target_grpc_proxies0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list")
        ...
        let mut target_http_proxies0 = SubCommand::with_name("target_http_proxies")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: aggregated_list, delete, get, insert, list, set_url_map and test_iam_permissions");
        {
        ...
        let mut target_pools0 = SubCommand::with_name("target_pools")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: add_health_check, add_instance, aggregated_list, delete, get, get_health, insert, list, remove_health_check, remove_instance, set_backup and test_iam_permissions");
        {
        ...
        let mut target_tcp_proxies0 = SubCommand::with_name("target_tcp_proxies")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: delete, get, insert, list, set_backend_service, set_proxy_header and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("delete")
        ...
        {
            let mcmd = SubCommand::with_name("set_labels").about("Sets the labels on a TargetVpnGateway. To learn more about labels, read the Labeling Resources documentation.");
            target_vpn_gateways0 = target_vpn_gateways0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("test_iam_permissions")
        ...
        let mut url_maps0 = SubCommand::with_name("url_maps")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: aggregated_list, delete, get, insert, invalidate_cache, list, patch, test_iam_permissions, update and validate");
        {
        ...
        {
            let mcmd = SubCommand::with_name("set_labels").about("Sets the labels on a VpnTunnel. To learn more about labels, read the Labeling Resources documentation.");
            vpn_tunnels0 = vpn_tunnels0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("test_iam_permissions")
        ...
        let mut zone_in_place_snapshots0 = SubCommand::with_name("zone_in_place_snapshots")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: delete, get, get_iam_policy, insert, list, set_iam_policy, set_labels and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("delete").about("Deletes the specified InPlaceSnapshot resource. Keep in mind that deleting a single inPlaceSnapshot might not necessarily delete all the data on that inPlaceSnapshot. If any data on the inPlaceSnapshot that is marked for deletion is needed for subsequent inPlaceSnapshots, the data will be moved to the next corresponding inPlaceSnapshot.\n\nFor more information, see Deleting inPlaceSnapshots.");
            zone_in_place_snapshots0 = zone_in_place_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get")
                .about("Returns the specified InPlaceSnapshot resource in the specified zone.");
            zone_in_place_snapshots0 = zone_in_place_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get_iam_policy").about("Gets the access control policy for a resource. May be empty if no such policy or resource exists.");
        ...
        {
            let mcmd = SubCommand::with_name("insert")
                .about("Creates an in-place snapshot in the specified zone.");
            zone_in_place_snapshots0 = zone_in_place_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list").about("Retrieves the list of InPlaceSnapshot resources contained within the specified zone.");
            zone_in_place_snapshots0 = zone_in_place_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("set_iam_policy").about("Sets the access control policy on the specified resource. Replaces any existing policy.");
        ...
        {
            let mcmd = SubCommand::with_name("set_labels").about("Sets the labels on a inPlaceSnapshot in the given zone. To learn more about labels, read the Labeling Resources documentation.");
            zone_in_place_snapshots0 = zone_in_place_snapshots0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("test_iam_permissions")
        ...
        app = app.subcommand(zone_in_place_snapshots0);
        ...
        app = app.subcommand(target_grpc_proxies0);
        ...
        app = app.subcommand(region_in_place_snapshots0);
        ...
        app = app.subcommand(public_delegated_prefixes0);
        app = app.subcommand(public_advertised_prefixes0);
        app = app.subcommand(projects0);
        app = app.subcommand(packet_mirrorings0);
        app = app.subcommand(organization_security_policies0);
        ...
        app = app.subcommand(global_public_delegated_prefixes0);
        app = app.subcommand(global_organization_operations0);
...
use google_computealpha as api;
