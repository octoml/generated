...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        ...
        let mut interconnect_attachments0 = SubCommand::with_name("interconnect_attachments")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: aggregated_list, delete, get, insert, list, patch, set_labels and test_iam_permissions");
        {
            let mcmd = SubCommand::with_name("aggregated_list")
        ...
        let mut interconnects0 = SubCommand::with_name("interconnects")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: delete, get, get_diagnostics, insert, list, patch, set_labels and test_iam_permissions");
        {
        ...
        let mut licenses0 = SubCommand::with_name("licenses")
            .setting(AppSettings::ColoredHelp)
            .about("methods: delete, get, get_iam_policy, insert, list and set_iam_policy");
        {
        ...
        let mut networks0 = SubCommand::with_name("networks")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: add_peering, delete, get, get_effective_firewalls, insert, list, list_peering_routes, patch, remove_peering, switch_to_custom_mode, test_iam_permissions and update_peering");
        {
        ...
        let mut region_commitments0 = SubCommand::with_name("region_commitments")
            .setting(AppSettings::ColoredHelp)
            .about("methods: aggregated_list, get, insert, list and update_reservations");
        {
            let mcmd = SubCommand::with_name("aggregated_list")
        ...
        let mut region_url_maps0 = SubCommand::with_name("region_url_maps")
            .setting(AppSettings::ColoredHelp)
            .about(
                "methods: delete, get, insert, invalidate_cache, list, patch, update and validate",
            );
        {
            let mcmd =
        ...
        let mut vpn_gateways0 = SubCommand::with_name("vpn_gateways")
            .setting(AppSettings::ColoredHelp)
            .about(
                "methods: aggregated_list, delete, get, get_status, insert, list and set_labels",
            );
        {
            let mcmd = SubCommand::with_name("aggregated_list")
