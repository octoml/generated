...
pub mod schemas {
    ...
    impl ::google_field_selector::ToFieldType for ActingUser {
    ...
    impl ::google_field_selector::ToFieldType for CertDnsChallenge {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for CertHttpChallenge {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for CloudRunRewrite {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub enum DomainStatus {
        ...
        DomainActive,
        #[doc = "An external operation is in progress on the domain association and no\nfurther operations can be performed until it is complete. Formerly used for\nmetabase updates.  Not currently used"]
        DomainChangePending,
        #[doc = "Unspecified domain association status."]
        DomainStatusUnspecified,
        #[doc = "The domain verification has been lost and the domain is in the grace period\nbefore being removed from the Firebase Hosting site."]
        DomainVerificationLost,
        #[doc = "The domain was previously verified in the legacy system. User must\nreverify the domain through the ownership service."]
        DomainVerificationRequired,
    }
    impl DomainStatus {
        pub fn as_str(self) -> &'static str {
            match self {
                DomainStatus::DomainActive => "DOMAIN_ACTIVE",
                DomainStatus::DomainChangePending => "DOMAIN_CHANGE_PENDING",
                DomainStatus::DomainStatusUnspecified => "DOMAIN_STATUS_UNSPECIFIED",
    ...
    impl ::google_field_selector::FieldSelector for DomainStatus {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DomainStatus {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for DomainProvisioning {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum DomainProvisioningCertStatus {
    ...
    impl DomainProvisioningCertStatus {
        pub fn as_str(self) -> &'static str {
            match self {
                DomainProvisioningCertStatus::CertActive => "CERT_ACTIVE",
                DomainProvisioningCertStatus::CertError => "CERT_ERROR",
                DomainProvisioningCertStatus::CertMissing => "CERT_MISSING",
                DomainProvisioningCertStatus::CertPending => "CERT_PENDING",
                DomainProvisioningCertStatus::CertProcessing => "CERT_PROCESSING",
    ...
    impl ::serde::Serialize for DomainProvisioningCertStatus {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for DomainProvisioningCertStatus {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for DomainProvisioningCertStatus {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DomainProvisioningCertStatus {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub enum DomainProvisioningDnsStatus {
        #[doc = "The domain has at least one of the required DNS records, and it has at\nleast one extra (non-required) DNS record."]
        DnsExtraneousMatch,
        #[doc = "All required DNS records were detected. No extra (non-required) DNS records\nwere detected."]
        DnsMatch,
        #[doc = "None of the required DNS records have been detected on the domain."]
        DnsMissing,
        #[doc = "Some of the required DNS records were detected, but not all of them. No\nextra (non-required) DNS records were detected."]
        DnsPartialMatch,
    ...
    impl DomainProvisioningDnsStatus {
        pub fn as_str(self) -> &'static str {
            match self {
                DomainProvisioningDnsStatus::DnsExtraneousMatch => "DNS_EXTRANEOUS_MATCH",
                DomainProvisioningDnsStatus::DnsMatch => "DNS_MATCH",
                DomainProvisioningDnsStatus::DnsMissing => "DNS_MISSING",
                DomainProvisioningDnsStatus::DnsPartialMatch => "DNS_PARTIAL_MATCH",
                DomainProvisioningDnsStatus::DnsPending => "DNS_PENDING",
                DomainProvisioningDnsStatus::DnsStatusUnspecified => "DNS_STATUS_UNSPECIFIED",
            }
        }
    }
    ...
    impl ::serde::Serialize for DomainProvisioningDnsStatus {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for DomainProvisioningDnsStatus {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for DomainProvisioningDnsStatus {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DomainProvisioningDnsStatus {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for DomainRedirect {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum DomainRedirectType {
        #[doc = "The redirect will respond with an HTTP status code of\n`301 Moved Permanently`."]
        MovedPermanently,
        #[doc = "The default redirect type; should not be intentionlly used."]
        RedirectTypeUnspecified,
    }
    impl DomainRedirectType {
        pub fn as_str(self) -> &'static str {
            match self {
    ...
    impl ::serde::Serialize for DomainRedirectType {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for DomainRedirectType {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for DomainRedirectType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for DomainRedirectType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for ListVersionFilesResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for PopulateVersionFilesRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for PopulateVersionFilesResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for Redirect {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub enum ReleaseType {
        ...
        Rollback,
        #[doc = "The release prevents the site from serving content. Firebase Hosting acts\nas if the site never existed."]
        SiteDisable,
        #[doc = "An unspecified type. Indicates that a version was released.\n<br>This is the default value when no other `type` is explicitly\nspecified."]
        TypeUnspecified,
    }
    impl ReleaseType {
        pub fn as_str(self) -> &'static str {
    ...
    impl ::google_field_selector::FieldSelector for ReleaseType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ReleaseType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for Rewrite {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for ServingConfig {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ServingConfig {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum ServingConfigAppAssociation {
        #[doc = "The app association files will be automattically created from the apps\nthat exist in the Firebase project."]
        Auto,
        #[doc = "No special handling of the app association files will occur, these paths\nwill result in a 404 unless caught with a Rewrite."]
        None,
    }
    impl ServingConfigAppAssociation {
        pub fn as_str(self) -> &'static str {
            match self {
    ...
    impl ::serde::Serialize for ServingConfigAppAssociation {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for ServingConfigAppAssociation {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for ServingConfigAppAssociation {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ServingConfigAppAssociation {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum ServingConfigTrailingSlashBehavior {
        #[doc = "Trailing slashes are *added* to directory indexes as well as to any URL\npath not ending in a file extension."]
        Add,
        #[doc = "Trailing slashes are *removed* from directory indexes as well as from any\nURL path not ending in a file extension."]
        Remove,
        #[doc = "No behavior is specified.\n<br>Files are served at their exact location only, and trailing slashes\nare only added to directory indexes."]
        TrailingSlashBehaviorUnspecified,
    }
    impl ServingConfigTrailingSlashBehavior {
        pub fn as_str(self) -> &'static str {
            match self {
                ServingConfigTrailingSlashBehavior::Add => "ADD",
                ServingConfigTrailingSlashBehavior::Remove => "REMOVE",
    ...
    impl ::serde::Serialize for ServingConfigTrailingSlashBehavior {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for ServingConfigTrailingSlashBehavior {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for ServingConfigTrailingSlashBehavior {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ServingConfigTrailingSlashBehavior {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct SiteConfig {
        #[doc = "Whether or not web requests made by site visitors are logged via Cloud\nLogging."]
        #[serde(
            rename = "cloudLoggingEnabled",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub cloud_logging_enabled: ::std::option::Option<bool>,
    ...
    impl ::google_field_selector::FieldSelector for SiteConfig {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SiteConfig {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub enum VersionStatus {
        ...
        Deleted,
        #[doc = "The version is outside the site-configured limit for the number of\nretained versions, so the version's content is scheduled for deletion."]
        Expired,
        #[doc = "All content has been added to the version, and the version can no longer be\nchanged."]
        Finalized,
    ...
    impl ::google_field_selector::FieldSelector for VersionStatus {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for VersionStatus {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for VersionFile {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum VersionFileStatus {
        #[doc = "The file has already been uploaded to Firebase Hosting."]
        Active,
        #[doc = "The file has been included in the version and is expected to be uploaded\nin the near future."]
        Expected,
        #[doc = "The default status; should not be intentionally used."]
        StatusUnspecified,
    }
    impl VersionFileStatus {
        pub fn as_str(self) -> &'static str {
            match self {
                VersionFileStatus::Active => "ACTIVE",
    ...
    impl ::serde::Serialize for VersionFileStatus {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for VersionFileStatus {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for VersionFileStatus {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for VersionFileStatus {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
pub mod resources {
    pub mod projects {
        ...
        impl<'a> ProjectsActions<'a> {
            ...
            #[doc = "Actions that can be performed on the sites resource"]
            pub fn sites(&self) -> crate::resources::projects::sites::SitesActions {
                crate::resources::projects::sites::SitesActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
            }
        ...
        pub mod operations {
            ...
            impl<'a> GetRequestBuilder<'a> {
                ...
                fn _path(&self) -> String {
                    let mut output = "https://firebasehosting.googleapis.com/".to_owned();
        ...
        pub mod sites {
            ...
            impl<'a> SitesActions<'a> {
                ...
                #[doc = "Gets the Hosting metadata for a specific site."]
                ...
                #[doc = "Sets the Hosting metadata for a specific site."]
                pub fn update_config(
                    &self,
                    request: crate::schemas::SiteConfig,
                ...
                pub fn channels(
                    &self,
                ) -> crate::resources::projects::sites::channels::ChannelsActions {
                    crate::resources::projects::sites::channels::ChannelsActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                    }
                ...
                pub fn domains(
                    &self,
                ) -> crate::resources::projects::sites::domains::DomainsActions {
                    crate::resources::projects::sites::domains::DomainsActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                    }
                ...
                pub fn releases(
                    &self,
                ) -> crate::resources::projects::sites::releases::ReleasesActions {
                    crate::resources::projects::sites::releases::ReleasesActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                    }
                ...
                pub fn versions(
                    &self,
                ) -> crate::resources::projects::sites::versions::VersionsActions {
                    crate::resources::projects::sites::versions::VersionsActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                    }
            ...
            impl<'a> GetConfigRequestBuilder<'a> {
                ...
                pub fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::SiteConfig, crate::Error> {
                    self.execute_with_fields(None::<&str>)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            pub mod channels {
                ...
                impl<'a> ChannelsActions<'a> {
                    ...
                    pub fn releases(
                        &self,
                    ) -> crate::resources::projects::sites::channels::releases::ReleasesActions
                    {
                        crate::resources::projects::sites::channels::releases::ReleasesActions {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                ...
                pub mod releases {
                    ...
                    impl<'a> ReleasesActions<'a> {
                        ...
                        #[doc = "Creates a new release which makes the content of the specified version\nactively display on the appropriate URL(s)."]
                        pub fn create(
                            &self,
                        ...
                        #[doc = "Lists the releases that have been created on the specified site."]
                    ...
                    impl<'a> CreateRequestBuilder<'a> {
                        ...
                        pub fn execute_with_default_fields(
                            self,
                        ) -> Result<crate::schemas::Release, crate::Error> {
                            self.execute_with_fields(None::<&str>)
                        }
                        #[doc = r" Execute the given operation. This will provide a `fields`"]
                        #[doc = r" selector of `*`. This will include every attribute of the"]
                        ...
                        ) -> Result<::reqwest::blocking::RequestBuilder, crate::Error>
                        {
                            ...
                            let req = req.query(&[("versionName", &self.version_name)]);
                            let req = req.query(&[("access_token", &self.access_token)]);
                            let req = req.query(&[("alt", &self.alt)]);
                            let req = req.query(&[("callback", &self.callback)]);
                            let req = req.query(&[("fields", &self.fields)]);
                    ...
                    impl<'a> ListRequestBuilder<'a> {
                        #[doc = "The page size to return. Defaults to 100."]
                        ...
                        pub fn execute_with_default_fields(
                            self,
                        ) -> Result<crate::schemas::ListReleasesResponse, crate::Error>
                        {
                            self.execute_with_fields(None::<&str>)
                        }
                        #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            pub mod domains {
                ...
                impl<'a> DomainsActions<'a> {
                    ...
                    #[doc = "Creates a domain mapping on the specified site."]
                    pub fn create(
                        &self,
                        request: crate::schemas::Domain,
                        parent: impl Into<String>,
                    ) -> CreateRequestBuilder {
                        CreateRequestBuilder {
                            reqwest: &self.reqwest,
                    ...
                    #[doc = "Deletes the existing domain mapping on the specified site."]
                    ...
                    #[doc = "Gets a domain mapping on the specified site."]
                    pub fn get(&self, name: impl Into<String>) -> GetRequestBuilder {
                        GetRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                    ...
                    #[doc = "Lists the domains for the specified site."]
                    pub fn list(&self, parent: impl Into<String>) -> ListRequestBuilder {
                        ListRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                    ...
                    #[doc = "Updates the specified domain mapping, creating the mapping as if it does\nnot exist."]
                    pub fn update(
                        &self,
                        request: crate::schemas::Domain,
                        name: impl Into<String>,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    pub fn iter_domains_with_default_fields(
                        self,
                    ) -> crate::iter::PageItemIter<Self, crate::schemas::Domain>
                    {
                    ...
                    pub fn iter_with_default_fields(
                        self,
                    ) -> crate::iter::PageIter<Self, crate::schemas::ListDomainsResponse>
                    {
                        self.iter_with_fields(None::<&str>)
                    }
                    pub fn iter_with_all_fields(
            ...
            pub mod versions {
                ...
                impl<'a> VersionsActions<'a> {
                    ...
                    #[doc = "Creates a new version for a site."]
                    pub fn create(
                        &self,
                    ...
                    #[doc = "Lists the versions that have been created on the specified site.\nWill include filtering in the future."]
                    pub fn list(&self, parent: impl Into<String>) -> ListRequestBuilder {
                        ListRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                    ...
                    #[doc = "Adds content files to a version."]
                    pub fn populate_files(
                        &self,
                        request: crate::schemas::PopulateVersionFilesRequest,
                        parent: impl Into<String>,
                    ) -> PopulateFilesRequestBuilder {
                        PopulateFilesRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                            request,
                    ...
                    pub fn files(
                        &self,
                    ) -> crate::resources::projects::sites::versions::files::FilesActions
                    {
                        crate::resources::projects::sites::versions::files::FilesActions {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
                ...
                impl<'a> CreateRequestBuilder<'a> {
                    #[doc = "The self-reported size of the version. This value is used for a pre-emptive\nquota check for legacy version uploads."]
                    pub fn size_bytes(mut self, value: i64) -> Self {
                        self.size_bytes = Some(value);
                        self
                    }
                    #[doc = "A unique id for the new version. This is only specified for legacy version\ncreations."]
                    ...
                    {
                        let req = self.reqwest.request(::reqwest::Method::POST, path);
                        let req = req.query(&[("sizeBytes", &self.size_bytes)]);
                        let req = req.query(&[("versionId", &self.version_id)]);
                        let req = req.query(&[("access_token", &self.access_token)]);
                        let req = req.query(&[("alt", &self.alt)]);
                        let req = req.query(&[("callback", &self.callback)]);
                        let req = req.query(&[("fields", &self.fields)]);
                ...
                impl<'a> PatchRequestBuilder<'a> {
                    #[doc = "A set of field names from your [version](../sites.versions) that you want\nto update.\n<br>A field will be overwritten if, and only if, it's in the mask.\n<br>If a mask is not provided then a default mask of only\n[`status`](../sites.versions#Version.FIELDS.status) will be used."]
                    pub fn update_mask(mut self, value: impl Into<String>) -> Self {
                        self.update_mask = Some(value.into());
                        self
                    }
                ...
                impl<'a> PopulateFilesRequestBuilder<'a> {
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        self.access_token = Some(value.into());
                        self
                    ...
                    pub fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::PopulateVersionFilesResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                pub mod files {
                        ...
                        impl ListStatus {
                            pub fn as_str(self) -> &'static str {
                                match self {
                                    ...
                                    ListStatus::Expected => "EXPECTED",
                                    ListStatus::StatusUnspecified => "STATUS_UNSPECIFIED",
                                }
                            }
                        }
                    ...
                    impl<'a> FilesActions<'a> {
                        ...
                        #[doc = "Lists the remaining files to be uploaded for the specified version."]
                        pub fn list(&self, parent: impl Into<String>) -> ListRequestBuilder {
                            ListRequestBuilder {
                                reqwest: &self.reqwest,
                                auth: self.auth_ref(),
                    ...
                    pub struct ListRequestBuilder<'a> {
                        ...
                        page_token: Option<String>,
                        status: Option<
                            crate::resources::projects::sites::versions::files::params::ListStatus,
                        >,
                        access_token: Option<String>,
                        alt: Option<crate::params::Alt>,
                        callback: Option<String>,
                    ...
                    impl<'a> ListRequestBuilder<'a> {
                        #[doc = "The page size to return. Defaults to 1000."]
                        pub fn page_size(mut self, value: i32) -> Self {
                            self.page_size = Some(value);
                            self
                        }
                        #[doc = "The next_page_token from a previous request, if provided. This will be the\nencoded version of a firebase.hosting.proto.metadata.ListFilesPageToken."]
                        pub fn page_token(mut self, value: impl Into<String>) -> Self {
                            self.page_token = Some(value.into());
                            self
                        }
                        #[doc = "The type of files in the version that should be listed."]
                        pub fn status(
                            mut self,
                            value : crate :: resources :: projects :: sites :: versions :: files :: params :: ListStatus,
                        ) -> Self {
                        ...
                        pub fn iter_files_with_default_fields(
                            self,
                        ) -> crate::iter::PageItemIter<Self, crate::schemas::VersionFile>
                        {
                        ...
                        pub fn iter_with_default_fields(
                            self,
                        ) -> crate::iter::PageIter<Self, crate::schemas::ListVersionFilesResponse>
                        {
                            self.iter_with_fields(None::<&str>)
                        }
                        pub fn iter_with_all_fields(
                        ...
                        pub fn execute_with_default_fields(
                            self,
                        ) -> Result<crate::schemas::ListVersionFilesResponse, crate::Error>
                        {
                            self.execute_with_fields(None::<&str>)
                        }
                        #[doc = r" Execute the given operation. This will provide a `fields`"]
    ...
    pub mod sites {
        ...
        impl<'a> SitesActions<'a> {
            ...
            #[doc = "Actions that can be performed on the channels resource"]
            pub fn channels(&self) -> crate::resources::sites::channels::ChannelsActions {
                crate::resources::sites::channels::ChannelsActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
            }
            #[doc = "Actions that can be performed on the domains resource"]
            pub fn domains(&self) -> crate::resources::sites::domains::DomainsActions {
                crate::resources::sites::domains::DomainsActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
            }
            #[doc = "Actions that can be performed on the releases resource"]
            pub fn releases(&self) -> crate::resources::sites::releases::ReleasesActions {
                crate::resources::sites::releases::ReleasesActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
            }
            #[doc = "Actions that can be performed on the versions resource"]
            pub fn versions(&self) -> crate::resources::sites::versions::VersionsActions {
                crate::resources::sites::versions::VersionsActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
            }
        ...
        pub mod channels {
            ...
            impl<'a> ChannelsActions<'a> {
                ...
                pub fn releases(
                    &self,
                ) -> crate::resources::sites::channels::releases::ReleasesActions {
                    crate::resources::sites::channels::releases::ReleasesActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                    }
        ...
        pub mod versions {
            ...
            impl<'a> VersionsActions<'a> {
                ...
                #[doc = "Actions that can be performed on the files resource"]
                pub fn files(&self) -> crate::resources::sites::versions::files::FilesActions {
                    crate::resources::sites::versions::files::FilesActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                    }
                }
            ...
            pub mod files {
                ...
                pub struct ListRequestBuilder<'a> {
                    ...
                    page_size: Option<i32>,
                    page_token: Option<String>,
                    status: Option<crate::resources::sites::versions::files::params::ListStatus>,
                    access_token: Option<String>,
                    alt: Option<crate::params::Alt>,
                    callback: Option<String>,
                    fields: Option<String>,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    pub fn status(
                        mut self,
                        value: crate::resources::sites::versions::files::params::ListStatus,
                    ) -> Self {
                        self.status = Some(value);
                        self
                    }
