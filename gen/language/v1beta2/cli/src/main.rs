...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        let mut app = App::new("language1_beta2")
        ...
        {
            let mcmd = SubCommand::with_name("annotate_text").about("A convenience method that provides all syntax, sentiment, entity, and\nclassification features in one call.");
            documents0 = documents0.subcommand(mcmd);
        }
        {
...
use google_language1_beta2 as api;
