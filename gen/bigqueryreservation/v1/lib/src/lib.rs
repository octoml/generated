...
pub mod schemas {
    ...
    pub struct Assignment {
        ...
        pub state: ::std::option::Option<crate::schemas::AssignmentState>,
    }
    ...
    impl ::std::convert::AsRef<str> for AssignmentJobType {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for AssignmentJobType {
        type Err = ();
    ...
    impl ::std::fmt::Display for AssignmentJobType {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for AssignmentJobType {
    ...
    impl<'de> ::serde::Deserialize<'de> for AssignmentJobType {
    ...
    impl ::google_field_selector::FieldSelector for AssignmentJobType {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AssignmentJobType {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl AssignmentState {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                AssignmentState::StateUnspecified => "STATE_UNSPECIFIED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for AssignmentState {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for AssignmentState {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<AssignmentState, ()> {
            Ok(match s {
                "ACTIVE" => AssignmentState::Active,
                "PENDING" => AssignmentState::Pending,
                "STATE_UNSPECIFIED" => AssignmentState::StateUnspecified,
                _ => return Err(()),
            })
        }
    }
    ...
    impl ::serde::Serialize for AssignmentState {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for AssignmentState {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for AssignmentState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AssignmentState {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for BiReservation {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for BiReservation {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct CapacityCommitment {
        ...
        pub renewal_plan: ::std::option::Option<crate::schemas::CapacityCommitmentRenewalPlan>,
        ...
        pub state: ::std::option::Option<crate::schemas::CapacityCommitmentState>,
    }
    impl ::google_field_selector::FieldSelector for CapacityCommitment {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CapacityCommitment {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl CapacityCommitmentPlan {
        pub fn as_str(self) -> &'static str {
            match self {
                CapacityCommitmentPlan::Annual => "ANNUAL",
    ...
    impl ::std::convert::AsRef<str> for CapacityCommitmentPlan {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for CapacityCommitmentPlan {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<CapacityCommitmentPlan, ()> {
            Ok(match s {
                "ANNUAL" => CapacityCommitmentPlan::Annual,
    ...
    impl ::std::fmt::Display for CapacityCommitmentPlan {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for CapacityCommitmentPlan {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for CapacityCommitmentPlan {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for CapacityCommitmentPlan {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CapacityCommitmentPlan {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl CapacityCommitmentRenewalPlan {
        pub fn as_str(self) -> &'static str {
            match self {
                CapacityCommitmentRenewalPlan::Annual => "ANNUAL",
                CapacityCommitmentRenewalPlan::CommitmentPlanUnspecified => {
    ...
    impl ::std::convert::AsRef<str> for CapacityCommitmentRenewalPlan {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for CapacityCommitmentRenewalPlan {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<CapacityCommitmentRenewalPlan, ()> {
            Ok(match s {
                "ANNUAL" => CapacityCommitmentRenewalPlan::Annual,
                "COMMITMENT_PLAN_UNSPECIFIED" => {
                    CapacityCommitmentRenewalPlan::CommitmentPlanUnspecified
                }
    ...
    impl ::std::fmt::Display for CapacityCommitmentRenewalPlan {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for CapacityCommitmentRenewalPlan {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for CapacityCommitmentRenewalPlan {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for CapacityCommitmentRenewalPlan {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for CapacityCommitmentRenewalPlan {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl CapacityCommitmentState {
        pub fn as_str(self) -> &'static str {
            match self {
                CapacityCommitmentState::Active => "ACTIVE",
                CapacityCommitmentState::Failed => "FAILED",
                CapacityCommitmentState::Pending => "PENDING",
                CapacityCommitmentState::StateUnspecified => "STATE_UNSPECIFIED",
            }
        }
    }
    impl ::std::convert::AsRef<str> for CapacityCommitmentState {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for CapacityCommitmentState {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<CapacityCommitmentState, ()> {
            Ok(match s {
                "ACTIVE" => CapacityCommitmentState::Active,
                "FAILED" => CapacityCommitmentState::Failed,
                "PENDING" => CapacityCommitmentState::Pending,
                "STATE_UNSPECIFIED" => CapacityCommitmentState::StateUnspecified,
                _ => return Err(()),
            })
        }
    }
    impl ::std::fmt::Display for CapacityCommitmentState {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for CapacityCommitmentState {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for CapacityCommitmentState {
        fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    impl ::google_field_selector::FieldSelector for CapacityCommitmentState {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for ListAssignmentsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListAssignmentsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for ListCapacityCommitmentsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ListCapacityCommitmentsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for ListReservationsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct MergeCapacityCommitmentsRequest {
        ...
        pub capacity_commitment_ids: ::std::option::Option<Vec<String>>,
    }
    impl ::google_field_selector::FieldSelector for MergeCapacityCommitmentsRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for MergeCapacityCommitmentsRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for MoveAssignmentRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for MoveAssignmentRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for Reservation {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for SearchAssignmentsResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SearchAssignmentsResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::FieldSelector for SplitCapacityCommitmentRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SplitCapacityCommitmentRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct SplitCapacityCommitmentResponse {
        ...
        pub first: ::std::option::Option<crate::schemas::CapacityCommitment>,
        ...
        pub second: ::std::option::Option<crate::schemas::CapacityCommitment>,
    }
    impl ::google_field_selector::FieldSelector for SplitCapacityCommitmentResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SplitCapacityCommitmentResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub mod operations {
        ...
        impl<'a> DeleteRequestBuilder<'a> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://bigqueryreservation.googleapis.com/".to_owned();
                output.push_str("v1/");
                {
    ...
    pub mod projects {
        ...
        pub mod locations {
            ...
            impl<'a> LocationsActions<'a> {
                ...
                ) -> GetBiReservationRequestBuilder {
                    GetBiReservationRequestBuilder {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                        access_token: None,
                ...
                ) -> SearchAssignmentsRequestBuilder {
                    SearchAssignmentsRequestBuilder {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                        access_token: None,
                ...
                pub fn update_bi_reservation(
                    ...
                    name: impl Into<String>,
                ) -> UpdateBiReservationRequestBuilder {
                    UpdateBiReservationRequestBuilder {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                        request,
                ...
                pub fn reservations(
                    &self,
                ) -> crate::resources::projects::locations::reservations::ReservationsActions
                {
                    crate::resources::projects::locations::reservations::ReservationsActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
            ...
            #[doc = "Created via [LocationsActions::get_bi_reservation()](struct.LocationsActions.html#method.get_bi_reservation)"]
            #[derive(Debug, Clone)]
            pub struct GetBiReservationRequestBuilder<'a> {
                pub(crate) reqwest: &'a ::reqwest::blocking::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                name: String,
                access_token: Option<String>,
            ...
            impl<'a> GetBiReservationRequestBuilder<'a> {
                #[doc = "OAuth access token."]
                pub fn access_token(mut self, value: impl Into<String>) -> Self {
                    self.access_token = Some(value.into());
                    self
                ...
                pub fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::BiReservation, crate::Error> {
                    self.execute_with_fields(None::<&str>)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            #[doc = "Created via [LocationsActions::search_assignments()](struct.LocationsActions.html#method.search_assignments)"]
            #[derive(Debug, Clone)]
            pub struct SearchAssignmentsRequestBuilder<'a> {
                pub(crate) reqwest: &'a ::reqwest::blocking::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                parent: String,
                page_size: Option<i32>,
            ...
            impl<'a> SearchAssignmentsRequestBuilder<'a> {
                #[doc = "The maximum number of items to return per page."]
                pub fn page_size(mut self, value: i32) -> Self {
                    self.page_size = Some(value);
                    self
                }
                ...
                pub fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::SearchAssignmentsResponse, crate::Error>
                {
                    self.execute_with_fields(None::<&str>)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            #[derive(Debug, Clone)]
            pub struct UpdateBiReservationRequestBuilder<'a> {
                pub(crate) reqwest: &'a ::reqwest::blocking::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                request: crate::schemas::BiReservation,
                name: String,
            ...
            impl<'a> UpdateBiReservationRequestBuilder<'a> {
            ...
            pub mod capacity_commitments {
                pub mod params {}
                pub struct CapacityCommitmentsActions<'a> {
                    pub(crate) reqwest: &'a reqwest::blocking::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                }
                impl<'a> CapacityCommitmentsActions<'a> {
                    fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                        self.auth
                    }
                ...
                #[doc = "Created via [CapacityCommitmentsActions::create()](struct.CapacityCommitmentsActions.html#method.create)"]
                #[derive(Debug, Clone)]
                ...
                impl<'a> CreateRequestBuilder<'a> {
                    ...
                    pub fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::CapacityCommitment, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                #[doc = "Created via [CapacityCommitmentsActions::delete()](struct.CapacityCommitmentsActions.html#method.delete)"]
                #[derive(Debug, Clone)]
                pub struct DeleteRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::blocking::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                #[doc = "Created via [CapacityCommitmentsActions::get()](struct.CapacityCommitmentsActions.html#method.get)"]
                #[derive(Debug, Clone)]
                ...
                #[doc = "Created via [CapacityCommitmentsActions::list()](struct.CapacityCommitmentsActions.html#method.list)"]
                #[derive(Debug, Clone)]
                pub struct ListRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::blocking::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    pub fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::ListCapacityCommitmentsResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                #[derive(Debug, Clone)]
                pub struct MergeRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::blocking::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    request: crate::schemas::MergeCapacityCommitmentsRequest,
                    parent: String,
                ...
                #[doc = "Created via [CapacityCommitmentsActions::patch()](struct.CapacityCommitmentsActions.html#method.patch)"]
                #[derive(Debug, Clone)]
                ...
                #[doc = "Created via [CapacityCommitmentsActions::split()](struct.CapacityCommitmentsActions.html#method.split)"]
                #[derive(Debug, Clone)]
                pub struct SplitRequestBuilder<'a> {
                    pub(crate) reqwest: &'a ::reqwest::blocking::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    request: crate::schemas::SplitCapacityCommitmentRequest,
                    name: String,
                ...
                impl<'a> SplitRequestBuilder<'a> {
                    ...
                    pub fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::SplitCapacityCommitmentResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            pub mod reservations {
                pub mod params {}
                pub struct ReservationsActions<'a> {
                    pub(crate) reqwest: &'a reqwest::blocking::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                }
                impl<'a> ReservationsActions<'a> {
                    fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                        self.auth
                    }
                    ...
                    pub fn create(
                        &self,
                        request: crate::schemas::Reservation,
                        parent: impl Into<String>,
                    ) -> CreateRequestBuilder {
                        CreateRequestBuilder {
                            reqwest: &self.reqwest,
                ...
                impl<'a> CreateRequestBuilder<'a> {
                    ...
                    pub fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::Reservation, crate::Error> {
                        self.execute_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                    #[doc = r" selector of `*`. This will include every attribute of the"]
                ...
                impl<'a> ListRequestBuilder<'a> {
                    ...
                    pub fn execute_with_default_fields(
                        self,
                    ) -> Result<crate::schemas::ListReservationsResponse, crate::Error>
                    {
                        self.execute_with_fields(None::<&str>)
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                pub mod assignments {
                    pub mod params {}
                    pub struct AssignmentsActions<'a> {
                        pub(crate) reqwest: &'a reqwest::blocking::Client,
                        pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    }
                    impl<'a> AssignmentsActions<'a> {
                        fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                            self.auth
                        }
                    ...
                    #[doc = "Created via [AssignmentsActions::delete()](struct.AssignmentsActions.html#method.delete)"]
                    #[derive(Debug, Clone)]
                    pub struct DeleteRequestBuilder<'a> {
                        pub(crate) reqwest: &'a ::reqwest::blocking::Client,
                        pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    ...
                    #[doc = "Created via [AssignmentsActions::list()](struct.AssignmentsActions.html#method.list)"]
                    #[derive(Debug, Clone)]
                    pub struct ListRequestBuilder<'a> {
                        pub(crate) reqwest: &'a ::reqwest::blocking::Client,
                        pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                    ...
                    impl<'a> ListRequestBuilder<'a> {
                        ...
                        pub fn execute_with_default_fields(
                            self,
                        ) -> Result<crate::schemas::ListAssignmentsResponse, crate::Error>
                        {
                            self.execute_with_fields(None::<&str>)
                        }
                        #[doc = r" Execute the given operation. This will provide a `fields`"]
