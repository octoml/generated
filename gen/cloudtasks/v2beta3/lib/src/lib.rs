...
pub mod schemas {
    ...
    impl ::google_field_selector::FieldSelector for AppEngineHttpQueue {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AppEngineHttpQueue {
    ...
    impl ::google_field_selector::FieldSelector for Attempt {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for Attempt {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct RateLimits {
        ...
        #[serde(
            rename = "maxConcurrentDispatches",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
