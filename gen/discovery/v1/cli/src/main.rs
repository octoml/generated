    ...
    fn default() -> Self {
        let mut app = App::new("discovery1")
            ...
            .arg(Arg::with_name("debug")
                ...
                .multiple(false)
                .takes_value(false));
        let mut apis0 = SubCommand::with_name("apis")
            .setting(AppSettings::ColoredHelp)
            .about("methods: get_rest and list");
        {
            let mcmd = SubCommand::with_name("get_rest")
                .about("Retrieve the description of a particular version of an api.");
            apis0 = apis0.subcommand(mcmd);
        }
        {
        ...
        app = app.subcommand(apis0);

        Self { app }
    }
}
use google_discovery1 as api;
